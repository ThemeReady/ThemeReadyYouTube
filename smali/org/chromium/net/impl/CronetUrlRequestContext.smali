...
.field private j:Lafhn;

.field private k:Lafhn;
...
.method public constructor <init>(Lafkx;)V
    ...
    iput-object v0, p0, Lorg/chromium/net/impl/CronetUrlRequestContext;->j:Lafhn;
    ...
    iput-object v0, p0, Lorg/chromium/net/impl/CronetUrlRequestContext;->k:Lafhn;
    ...
    .line 16
    iget-object v0, p1, Lafkx;->a:Landroid/content/Context;

    .line 17
    invoke-static {v0, p1}, Lorg/chromium/net/impl/CronetLibraryLoader;->a(Landroid/content/Context;Lafkx;)V
    ...
    .line 22
    :try_start_0
    invoke-static {p1}, Lorg/chromium/net/impl/CronetUrlRequestContext;->a(Lafkx;)J
    ...
    invoke-direct {v0, p0}, Laflr;-><init>(Lorg/chromium/net/impl/CronetUrlRequestContext;)V
...
.method private static a(Lafkx;)J
    .locals 19
    ...
    iget-object v2, v0, Lafkx;->e:Ljava/lang/String;

    .line 31
    move-object/from16 v0, p0

    iget-object v3, v0, Lafkx;->f:Ljava/lang/String;

    .line 33
    move-object/from16 v0, p0

    iget-boolean v4, v0, Lafkx;->h:Z

    .line 36
    move-object/from16 v0, p0

    iget-boolean v5, v0, Lafkx;->h:Z

    if-eqz v5, :cond_0

    move-object/from16 v0, p0

    iget-object v5, v0, Lafkx;->a:Landroid/content/Context;

    invoke-static {v5}, Lafnx;->b(Landroid/content/Context;)Ljava/lang/String;
    ...
    iget-boolean v6, v0, Lafkx;->i:Z

    .line 40
    move-object/from16 v0, p0

    iget-boolean v7, v0, Lafkx;->j:Z

    .line 42
    move-object/from16 v0, p0

    iget-boolean v8, v0, Lafkx;->k:Z

    .line 44
    move-object/from16 v0, p0

    iget-boolean v9, v0, Lafkx;->l:Z

    .line 46
    move-object/from16 v0, p0

    iget v10, v0, Lafkx;->m:I

    .line 48
    move-object/from16 v0, p0

    iget-wide v11, v0, Lafkx;->n:J

    .line 50
    move-object/from16 v0, p0

    iget-object v13, v0, Lafkx;->o:Ljava/lang/String;
    ...
    iget-object v4, v0, Lafkx;->b:Ljava/util/List;
    ...
    .line 61
    iget-object v6, v4, Lafkz;->a:Ljava/lang/String;

    iget v7, v4, Lafkz;->b:I

    iget v4, v4, Lafkz;->c:I
    ...
    iget-object v4, v0, Lafkx;->c:Ljava/util/List;
    ...
    .line 66
    iget-object v4, v7, Lafky;->a:Ljava/lang/String;

    iget-object v5, v7, Lafky;->b:[[B

    iget-boolean v6, v7, Lafky;->c:Z

    iget-object v7, v7, Lafky;->d:Ljava/util/Date;
...
.method private onRttObservation(IJI)V
    ...
    .line 136
    :try_start_0
    iget-object v0, p0, Lorg/chromium/net/impl/CronetUrlRequestContext;->j:Lafhn;

    invoke-virtual {v0}, Lafhn;->iterator()Ljava/util/Iterator;
    ...
    invoke-direct/range {v1 .. v6}, Lafls;-><init>(Lafoa;IJI)V

    .line 138
    invoke-virtual {v2}, Lafjp;->a()Ljava/util/concurrent/Executor;
...
.method private onThroughputObservation(IJI)V
    ...
    .line 142
    :try_start_0
    iget-object v0, p0, Lorg/chromium/net/impl/CronetUrlRequestContext;->k:Lafhn;
    ...
    invoke-direct/range {v1 .. v6}, Laflt;-><init>(Lafob;IJI)V

    .line 144
    invoke-virtual {v2}, Lafjq;->a()Ljava/util/concurrent/Executor;
...
.method protected final a(Ljava/lang/String;Lafih;Ljava/util/concurrent/Executor;Ljava/lang/String;Ljava/util/List;IZLjava/util/Collection;)Lafip;
    ...
    invoke-direct/range {v0 .. v9}, Lorg/chromium/net/impl/CronetBidirectionalStream;-><init>(Lorg/chromium/net/impl/CronetUrlRequestContext;Ljava/lang/String;ILafih;Ljava/util/concurrent/Executor;Ljava/lang/String;Ljava/util/List;ZLjava/util/Collection;)V
...
.method public final a(Ljava/lang/String;Lafih;Ljava/util/concurrent/Executor;)Lafiq;
    ...
    invoke-direct {v0, p1, p2, p3, p0}, Lafkn;-><init>(Ljava/lang/String;Lafih;Ljava/util/concurrent/Executor;Lafkw;)V
...
.method public final a(Ljava/lang/String;Lafkf;Ljava/util/concurrent/Executor;ILjava/util/Collection;ZZZ)Lafnt;
    ...
    invoke-direct/range {v0 .. v9}, Lorg/chromium/net/impl/CronetUrlRequest;-><init>(Lorg/chromium/net/impl/CronetUrlRequestContext;Ljava/lang/String;ILafkf;Ljava/util/concurrent/Executor;Ljava/util/Collection;ZZZ)V
...
.method public final a(Ljava/net/URL;)Ljava/net/URLConnection;
    ...
    invoke-virtual {p0, p1, v0}, Lafir;->a(Ljava/net/URL;Ljava/net/Proxy;)Ljava/net/URLConnection;
...
.method public final a(Ljava/net/URL;Ljava/net/Proxy;)Ljava/net/URLConnection;
    ...
    invoke-direct {v0, p1, p0}, Lafol;-><init>(Ljava/net/URL;Lafij;)V
...
.method final a(Lafjx;)V
    ...
    invoke-direct {v4, v1, p1}, Laflu;-><init>(Lafoc;Lafjx;)V

    .line 155
    invoke-virtual {v1}, Lafjy;->a()Ljava/util/concurrent/Executor;
...
.method public final a(Lafjy;)V
    ...
    new-instance v2, Lafoc;

    invoke-direct {v2, p1}, Lafoc;-><init>(Lafjy;)V
