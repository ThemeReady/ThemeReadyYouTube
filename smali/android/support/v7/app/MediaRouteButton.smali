...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 5
    invoke-static {p1, p3}, Lafa;->a(Landroid/content/Context;I)Landroid/content/Context;
    ...
    iput-object v0, p0, Landroid/support/v7/app/MediaRouteButton;->c:Lahg;

    .line 8
    sget-object v0, Laex;->a:Laex;

    .line 9
    iput-object v0, p0, Landroid/support/v7/app/MediaRouteButton;->d:Laex;
    ...
    iput-object v1, p0, Landroid/support/v7/app/MediaRouteButton;->a:Lahi;

    .line 12
    new-instance v1, Ladv;

    invoke-direct {v1, p0}, Ladv;-><init>(Landroid/support/v7/app/MediaRouteButton;)V

    iput-object v1, p0, Landroid/support/v7/app/MediaRouteButton;->b:Ladv;

    .line 13
    sget-object v1, Lajp;->a:[I
...
.method public final a()V
    ...
    .line 168
    invoke-virtual {v1}, Lahx;->c()Z

    move-result v3

    if-nez v3, :cond_6

    iget-object v3, p0, Landroid/support/v7/app/MediaRouteButton;->c:Lahg;

    invoke-virtual {v1, v3}, Lahx;->a(Lahg;)Z
    ...
    .line 183
    iget-object v4, p0, Landroid/support/v7/app/MediaRouteButton;->c:Lahg;

    invoke-static {v4, v0}, Lahi;->a(Lahg;I)Z
...
.method public final a(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {p1, v0}, Lls;->a(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
...
.method public jumpDrawablesToCurrentState()V
    ...
    invoke-static {v0}, Lls;->a(Landroid/graphics/drawable/Drawable;)V
...
.method public onAttachedToWindow()V
    ...
    .line 120
    iget-object v0, p0, Landroid/support/v7/app/MediaRouteButton;->c:Lahg;
    ...
    .line 121
    iget-object v0, p0, Landroid/support/v7/app/MediaRouteButton;->a:Lahi;

    iget-object v1, p0, Landroid/support/v7/app/MediaRouteButton;->c:Lahg;

    iget-object v2, p0, Landroid/support/v7/app/MediaRouteButton;->b:Ladv;
...
.method public onDetachedFromWindow()V
    ...
    iget-object v1, p0, Landroid/support/v7/app/MediaRouteButton;->b:Ladv;
...
.method public performClick()Z
    ...
    iget-object v5, p0, Landroid/support/v7/app/MediaRouteButton;->c:Lahg;

    invoke-virtual {v0, v5}, Lahx;->a(Lahg;)Z
    ...
    .line 48
    :cond_8
    iget-object v0, p0, Landroid/support/v7/app/MediaRouteButton;->d:Laex;

    .line 49
    invoke-virtual {v0}, Laex;->a()Laeb;

    move-result-object v5

    .line 50
    iget-object v6, p0, Landroid/support/v7/app/MediaRouteButton;->c:Lahg;
    ...
    .line 53
    :cond_9
    invoke-virtual {v5}, Laeb;->L()V

    .line 54
    iget-object v0, v5, Laeb;->V:Lahg;

    invoke-virtual {v0, v6}, Lahg;->equals(Ljava/lang/Object;)Z
    ...
    .line 55
    iput-object v6, v5, Laeb;->V:Lahg;

    .line 57
    iget-object v0, v5, Lfy;->j:Landroid/os/Bundle;
    ...
    .line 62
    iget-object v8, v6, Lahg;->a:Landroid/os/Bundle;

    .line 63
    invoke-virtual {v0, v7, v8}, Landroid/os/Bundle;->putBundle(Ljava/lang/String;Landroid/os/Bundle;)V

    .line 64
    invoke-virtual {v5, v0}, Lfy;->f(Landroid/os/Bundle;)V

    .line 66
    iget-object v0, v5, Lfx;->c:Landroid/app/Dialog;
    ...
    .line 69
    invoke-virtual {v0, v6}, Ladw;->a(Lahg;)V

    .line 70
    :cond_b
    const-string v0, "android.support.v7.mediarouter:MediaRouteChooserDialogFragment"

    invoke-virtual {v5, v1, v0}, Lfx;->a(Lgm;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, v5}, Lfx;->a(Lgm;Ljava/lang/String;)V
