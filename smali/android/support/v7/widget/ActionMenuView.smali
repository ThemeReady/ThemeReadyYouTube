...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 3
    invoke-direct {p0, p1, p2}, Laqi;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    .line 4
    invoke-virtual {p0, v2}, Laqi;->setBaselineAligned(Z)V
...
.method public static a(Landroid/view/ViewGroup$LayoutParams;)Lang;
    .locals 2
    ...
    invoke-direct {v0, p0}, Lang;-><init>(Lang;)V
    ...
    invoke-direct {v0, p0}, Lang;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public final a(Lall;)V
    ...
    .prologue
    .line 277
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->a:Lall;
...
.method public final a(Lamc;Lalm;)V
    ...
    .prologue
    .line 290
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->h:Lamc;

    .line 291
    iput-object p2, p0, Landroid/support/v7/widget/ActionMenuView;->d:Lalm;
...
.method public final a(Lamw;)V
    ...
    .prologue
    .line 17
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuView;->c:Lamw;

    .line 18
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->c:Lamw;

    invoke-virtual {v0, p0}, Lamw;->a(Landroid/support/v7/widget/ActionMenuView;)V
...
.method public final a(Lalp;)Z
    ...
    .prologue
    .line 274
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->a:Lall;
    ...
    invoke-virtual {v0, p1, v1, v2}, Lall;->a(Landroid/view/MenuItem;Lamb;I)Z
...
.method public final b()Landroid/view/Menu;
    ...
    invoke-direct {v1, v0}, Lall;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->a:Lall;

    .line 282
    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->a:Lall;

    new-instance v2, Lanh;

    invoke-direct {v2, p0}, Lanh;-><init>(Landroid/support/v7/widget/ActionMenuView;)V

    invoke-virtual {v1, v2}, Lall;->a(Lalm;)V

    .line 283
    new-instance v1, Lamw;

    invoke-direct {v1, v0}, Lamw;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->c:Lamw;
    ...
    .line 285
    iget-object v1, p0, Landroid/support/v7/widget/ActionMenuView;->c:Lamw;

    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->h:Lamc;
...
.method protected synthetic generateDefaultLayoutParams()Laqj;
    .locals 1
...
.method public synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, Lang;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method protected synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    .prologue
    .line 311
    invoke-static {p1}, Landroid/support/v7/widget/ActionMenuView;->a(Landroid/view/ViewGroup$LayoutParams;)Lang;
...
.method public bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Laqj;
    .locals 1

    .prologue
    .line 309
    invoke-virtual {p0, p1}, Laqi;->generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
...
.method protected synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Laqj;
    .locals 1
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .prologue
    .line 20
    invoke-super {p0, p1}, Laqi;->onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v0, v1}, Lala;->a(Z)V

    .line 23
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuView;->c:Lamw;

    invoke-virtual {v0}, Lamw;->g()Z
...
.method protected onLayout(ZIIII)V
    ...
    .line 193
    invoke-virtual {p0}, Laqi;->getDividerWidth()I
    ...
    iget-boolean v5, v0, Lang;->a:Z

    if-nez v5, :cond_b

    .line 240
    iget v5, v0, Lang;->rightMargin:I
...
.method protected onMeasure(II)V
    ...
    iget-object v7, v0, Landroid/support/v7/widget/ActionMenuView;->a:Lall;
    ...
    iget-object v6, v0, Landroid/support/v7/widget/ActionMenuView;->a:Lall;

    const/4 v7, 0x1

    invoke-virtual {v6, v7}, Lall;->b(Z)V
    ...
    iput-boolean v7, v6, Lang;->d:Z

    .line 71
    const/4 v7, 0x0

    iput v7, v6, Lang;->leftMargin:I

    .line 72
    const/4 v7, 0x0

    iput v7, v6, Lang;->rightMargin:I
    ...
    :goto_3
    iput-boolean v7, v6, Lang;->e:Z

    .line 74
    iget-boolean v7, v6, Lang;->a:Z
    ...
    iput-boolean v8, v6, Lang;->f:Z

    .line 156
    if-nez v9, :cond_17

    iget-boolean v8, v6, Lang;->e:Z
    ...
    iput v12, v6, Lang;->rightMargin:I
    ...
    iput v9, v6, Lang;->rightMargin:I

    iput v9, v6, Lang;->leftMargin:I
    ...
    .line 186
    :cond_23
    invoke-super/range {p0 .. p2}, Laqi;->onMeasure(II)V
