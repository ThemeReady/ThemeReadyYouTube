...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 5
    invoke-direct {p0, p1, p2, p3}, Lamm;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    .line 6
    sget-object v0, Lagd;->x:[I

    invoke-static {p1, p2, v0, p3, v2}, Laui;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Laui;
    ...
    invoke-virtual {v0, v1, v2}, Laui;->f(II)I
...
.method public final a(Lakk;)V
    ...
    invoke-direct {v1, p1}, Lamq;-><init>(Lakk;)V

    invoke-virtual {v0, v1}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 65
    invoke-virtual {p1}, Lakk;->b()Landroid/view/Menu;
    ...
    .line 66
    iget-object v1, p0, Landroid/support/v7/widget/ActionBarContextView;->c:Lamw;
    ...
    invoke-direct {v1, v2}, Lamw;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Landroid/support/v7/widget/ActionBarContextView;->c:Lamw;

    .line 69
    iget-object v1, p0, Landroid/support/v7/widget/ActionBarContextView;->c:Lamw;

    invoke-virtual {v1}, Lamw;->b()V
    ...
    .line 71
    iget-object v2, p0, Landroid/support/v7/widget/ActionBarContextView;->c:Lamw;

    iget-object v3, p0, Landroid/support/v7/widget/ActionBarContextView;->a:Landroid/content/Context;

    invoke-virtual {v0, v2, v3}, Lall;->a(Lamb;Landroid/content/Context;)V

    .line 72
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->c:Lamw;

    invoke-virtual {v0, p0}, Lala;->a(Landroid/view/ViewGroup;)Lamd;
...
.method public onDetachedFromWindow()V
    ...
    .prologue
    .line 15
    invoke-super {p0}, Lamm;->onDetachedFromWindow()V
...
.method public onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    .line 165
    :cond_1
    invoke-super {p0, p1}, Lamm;->onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
