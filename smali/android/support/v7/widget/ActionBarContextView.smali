...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 5
    invoke-direct {p0, p1, p2, p3}, Lalx;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    .line 6
    sget-object v0, Lafo;->x:[I

    invoke-static {p1, p2, v0, p3, v2}, Latx;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Latx;
    ...
    invoke-static {p0, v1}, Luj;->a(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, v1, v2}, Latx;->f(II)I
...
.method public final a(Lajv;)V
    ...
    invoke-direct {v1, p1}, Lamb;-><init>(Lajv;)V

    invoke-virtual {v0, v1}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 65
    invoke-virtual {p1}, Lajv;->b()Landroid/view/Menu;
    ...
    .line 66
    iget-object v1, p0, Landroid/support/v7/widget/ActionBarContextView;->c:Lamh;
    ...
    invoke-direct {v1, v2}, Lamh;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Landroid/support/v7/widget/ActionBarContextView;->c:Lamh;

    .line 69
    iget-object v1, p0, Landroid/support/v7/widget/ActionBarContextView;->c:Lamh;

    invoke-virtual {v1}, Lamh;->b()V
    ...
    .line 71
    iget-object v2, p0, Landroid/support/v7/widget/ActionBarContextView;->c:Lamh;

    iget-object v3, p0, Landroid/support/v7/widget/ActionBarContextView;->a:Landroid/content/Context;

    invoke-virtual {v0, v2, v3}, Lakw;->a(Lalm;Landroid/content/Context;)V

    .line 72
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->c:Lamh;

    invoke-virtual {v0, p0}, Lakl;->a(Landroid/view/ViewGroup;)Lalo;
...
.method public onDetachedFromWindow()V
    ...
    .prologue
    .line 15
    invoke-super {p0}, Lalx;->onDetachedFromWindow()V
...
.method public onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    .line 165
    :cond_1
    invoke-super {p0, p1}, Lalx;->onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
