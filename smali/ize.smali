...
.field private h:Lodx;

.field private volatile i:Landroid/graphics/Point;


# direct methods
.method public constructor <init>(Lufx;Lcom/google/android/apps/youtube/embeddedplayer/service/service/jar/RemoteSurfaceHolder;)V
    .locals 3
    ...
    .line 3
    iput-object p1, p0, Lize;->g:Lufx;

    .line 4
    iput-object p2, p0, Lize;->b:Lcom/google/android/apps/youtube/embeddedplayer/service/service/jar/RemoteSurfaceHolder;

    .line 5
    new-instance v1, Lizi;

    .line 6
    invoke-direct {v1, p0}, Lizi;-><init>(Lize;)V

    .line 7
    iput-object v1, p0, Lize;->c:Lizi;

    .line 8
    iget-object v1, p0, Lize;->b:Lcom/google/android/apps/youtube/embeddedplayer/service/service/jar/RemoteSurfaceHolder;

    iget-object v2, p0, Lize;->c:Lizi;
    ...
    .line 10
    sget-object v0, Lize;->f:Landroid/os/HandlerThread;
    ...
    .line 12
    sput-object v0, Lize;->f:Landroid/os/HandlerThread;
    ...
    sget-object v1, Lize;->f:Landroid/os/HandlerThread;

    invoke-virtual {v1}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v1

    invoke-direct {v0, v1}, Lizf;-><init>(Landroid/os/Looper;)V

    sput-object v0, Lize;->a:Landroid/os/Handler;
...
.method public final a()V
    ...
    .line 28
    iput-object v1, p0, Lize;->i:Landroid/graphics/Point;

    .line 29
    iget-object v0, p0, Lize;->h:Lodx;
...
.method public final a(Laawo;)V
    ...
    .line 19
    :cond_0
    invoke-static {p1}, Labmy;->e(Laawo;)Laawq;
    ...
    iget-object v1, v0, Laawq;->a:Ljava/lang/String;
    ...
    .line 24
    invoke-direct {v1, p0}, Lizh;-><init>(Lize;)V
...
.method final c()V
    ...
    .prologue
    .line 40
    invoke-static {}, Lize;->b()V

    .line 41
    iget-object v0, p0, Lize;->e:Landroid/support/rastermill/FrameSequenceDrawable;
    ...
    iput-object v0, p0, Lize;->e:Landroid/support/rastermill/FrameSequenceDrawable;
...
.method final d()V
    ...
    iget-object v0, p0, Lize;->b:Lcom/google/android/apps/youtube/embeddedplayer/service/service/jar/RemoteSurfaceHolder;
    ...
    .line 49
    :cond_1
    iget-object v1, p0, Lize;->e:Landroid/support/rastermill/FrameSequenceDrawable;
    ...
    iget-object v0, p0, Lize;->i:Landroid/graphics/Point;
