...
.method public constructor <init>(Landroid/content/Context;Lbqg;)V
    ...
    invoke-direct {v0, v1, v2}, Lbqh;-><init>(Landroid/os/Looper;Ljava/lang/ref/WeakReference;)V

    iput-object v0, p0, Lbqf;->c:Lbqh;

    .line 5
    iput-object p1, p0, Lbqf;->d:Landroid/content/Context;

    .line 6
    iput-object p2, p0, Lbqf;->b:Lbqg;
...
.method final a(Lbqz;)V
    ...
    .line 23
    :try_start_0
    iget-object v0, p0, Lbqf;->d:Landroid/content/Context;
...
.method public final a(Lbqt;)Z
    ...
    iget-object v0, p0, Lbqf;->c:Lbqh;

    .line 11
    invoke-virtual {v0, v2}, Lbqh;->obtainMessage(I)Landroid/os/Message;

    move-result-object v0

    invoke-direct {v1, p1, v0}, Lbqz;-><init>(Lbqt;Landroid/os/Message;)V

    .line 12
    iget-object v2, p0, Lbqf;->a:Lrp;

    monitor-enter v2

    .line 13
    :try_start_0
    iget-object v0, p0, Lbqf;->a:Lrp;
    ...
    .line 18
    iget-object v4, p0, Lbqf;->d:Landroid/content/Context;
