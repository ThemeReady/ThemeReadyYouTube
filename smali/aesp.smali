...
.method static constructor <clinit>()V
    ...
    sput-object v0, Laesp;->a:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/ContentProviderClient;Ljava/lang/String;)V
    ...
    .line 6
    :cond_2
    iput-object p1, p0, Laesp;->b:Landroid/content/ContentProviderClient;

    .line 7
    const-string v0, "device_params"

    .line 8
    invoke-static {p2, v0}, Laeul;->a(Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v0

    iput-object v0, p0, Laesp;->c:Landroid/net/Uri;
    ...
    iput-object v0, p0, Laesp;->d:Landroid/net/Uri;
    ...
    iput-object v0, p0, Laesp;->e:Landroid/net/Uri;
    ...
    iput-object v0, p0, Laesp;->f:Landroid/net/Uri;

    .line 15
    return-void
.end method

.method private final a(Ladwh;Landroid/net/Uri;Ljava/lang/String;)Ladwh;
    .locals 7
    ...
    .line 25
    :try_start_0
    iget-object v0, p0, Laesp;->b:Landroid/content/ContentProviderClient;
    ...
    :try_end_0
    .catch Ladwg; {:try_start_0 .. :try_end_0} :catch_2
    ...
    :try_end_1
    .catch Ladwg; {:try_start_1 .. :try_end_1} :catch_3
    ...
    :try_end_2
    .catch Ladwg; {:try_start_2 .. :try_end_2} :catch_3
    ...
    :cond_3
    :try_start_3
    sget-object v0, Laesp;->a:Ljava/lang/String;
    ...
    :try_end_3
    .catch Ladwg; {:try_start_3 .. :try_end_3} :catch_3
    ...
    :goto_1
    :try_start_4
    sget-object v2, Laesp;->a:Ljava/lang/String;
...
.method private final a(Ladwh;Landroid/net/Uri;)Z
    .locals 5
    ...
    .line 48
    :try_start_0
    iget-object v1, p0, Laesp;->b:Landroid/content/ContentProviderClient;
    ...
    .line 52
    iget-object v2, p0, Laesp;->b:Landroid/content/ContentProviderClient;
...
.method public final a(Laexd;)Ladnn;
    ...
    .line 20
    sget-object v1, Lcom/google/vr/ndk/base/SdkConfigurationReader;->DEFAULT_PARAMS:Ladnn;

    iget-object v2, p0, Laesp;->f:Landroid/net/Uri;

    invoke-direct {p0, v1, v2, v0}, Laesp;->a(Ladwh;Landroid/net/Uri;Ljava/lang/String;)Ladwh;
...
.method public final a()Lcom/google/vr/sdk/proto/nano/CardboardDevice$DeviceParams;
    ...
    iget-object v1, p0, Laesp;->c:Landroid/net/Uri;

    const/4 v2, 0x0

    invoke-direct {p0, v0, v1, v2}, Laesp;->a(Ladwh;Landroid/net/Uri;Ljava/lang/String;)Ladwh;
...
.method public final a(Lcom/google/vr/sdk/proto/nano/CardboardDevice$DeviceParams;)Z
    ...
    .prologue
    .line 17
    iget-object v0, p0, Laesp;->c:Landroid/net/Uri;

    invoke-direct {p0, p1, v0}, Laesp;->a(Ladwh;Landroid/net/Uri;)Z
...
.method public final b()Lcom/google/vr/sdk/proto/nano/Phone$PhoneParams;
    ...
    iget-object v1, p0, Laesp;->e:Landroid/net/Uri;
...
.method public final c()Lcom/google/vr/sdk/proto/nano/Preferences$UserPrefs;
    ...
    iget-object v1, p0, Laesp;->d:Landroid/net/Uri;
