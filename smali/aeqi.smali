...
# direct methods
.method public constructor <init>(Ljava/net/HttpURLConnection;Ljava/lang/String;Laeqc;Laeqa;IILaeqf;)V
    .locals 5
    ...
    .line 3
    iput v4, p0, Laeqi;->g:I

    .line 4
    iput-object p1, p0, Laeqi;->b:Ljava/net/HttpURLConnection;
    ...
    .line 12
    iput-object p4, p0, Laeqi;->c:Laeqa;
    ...
    :cond_0
    :goto_0
    invoke-virtual {p3}, Laeqc;->a()Ljava/util/Set;
    ...
    .line 23
    invoke-virtual {p3, v0}, Laeqc;->a(Ljava/lang/String;)Ljava/util/List;
...
.method private final f()Laeqd;
    ...
    .prologue
    .line 88
    invoke-direct {p0}, Laeqi;->h()V

    .line 89
    :try_start_0
    iget-object v0, p0, Laeqi;->b:Ljava/net/HttpURLConnection;
    ...
    .line 98
    iget-object v1, p0, Laeqi;->b:Ljava/net/HttpURLConnection;
    ...
    .line 104
    invoke-virtual {v3, v0, v1}, Laeqc;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v1, v4, v0, v2}, Laeqd;-><init>(ILaeqc;Ljava/io/InputStream;)V
...
.method private final g()Z
    ...
    .line 108
    :try_start_0
    iget-object v0, p0, Laeqi;->c:Laeqa;
...
.method public final a()Ladpu;
    ...
    invoke-direct {v0, p0}, Laeqj;-><init>(Laeqi;)V
...
.method public final declared-synchronized a(Laeqz;II)V
    ...
    :try_start_0
    iput-object p1, p0, Laeqi;->a:Laeqz;

    .line 126
    if-lez p2, :cond_0

    .line 127
    iput p2, p0, Laeqi;->f:I
...
.method final e()Laeqd;
    ...
    .line 38
    :try_start_0
    iget-object v0, p0, Laeqi;->a:Laeqz;
    ...
    .line 52
    invoke-direct {p0}, Laeqi;->f()Laeqd;
    ...
    invoke-direct {p0}, Laeqi;->f()Laeqd;
    :try_end_3
    .catch Laeqw; {:try_start_3 .. :try_end_3} :catch_2
    ...
    .line 61
    :try_start_4
    iget-object v7, p0, Laeqi;->c:Laeqa;

    sub-int v8, v12, v4

    invoke-interface {v7, v6, v4, v8}, Laeqa;->a([BII)I

    move-result v7

    .line 62
    iget-wide v8, p0, Laeqi;->d:J

    int-to-long v10, v7

    add-long/2addr v8, v10

    iput-wide v8, p0, Laeqi;->d:J
    :try_end_4
    ...
    .line 82
    :try_start_6
    iget-object v2, p0, Laeqi;->a:Laeqz;
    ...
    invoke-virtual {v2, p0}, Laeqz;->b(Laeqv;)V
