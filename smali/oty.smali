...
.method public static a(Landroid/content/Context;FF)F
    ...
    .line 102
    invoke-static {v1, p2}, Lovm;->b(Landroid/util/DisplayMetrics;F)F

    move-result v2

    .line 103
    invoke-static {v1, p1}, Lovm;->b(Landroid/util/DisplayMetrics;F)F
    ...
    .line 109
    invoke-static {p0}, Lovm;->f(Landroid/content/Context;)I

    move-result v4

    invoke-static {v3, v4}, Lovm;->b(Landroid/util/DisplayMetrics;I)I
    ...
    .line 114
    :cond_1
    invoke-static {v1, v0}, Lovm;->a(Landroid/util/DisplayMetrics;F)F
...
.method public static a(Landroid/content/Context;Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;F)Landroid/graphics/Bitmap;
    ...
    invoke-interface {v0, p0, p1, p2, p3}, Lotb;->a(Landroid/content/Context;Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;F)Landroid/graphics/Bitmap;
...
.method public static a(Landroid/view/View;Landroid/graphics/drawable/Drawable;I)V
    ...
    .line 47
    invoke-static {p0, p1}, Loub;->b(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 53
    :goto_2
    invoke-static {p0, v0}, Loub;->b(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
...
.method public static a(Landroid/view/View;Landroid/view/View;)Z
    ...
    invoke-static {p0, p1}, Loty;->a(Landroid/view/ViewParent;Landroid/view/View;)Z
...
.method public static b(Landroid/content/Context;Ljava/lang/CharSequence;I)V
    ...
    .prologue
    .line 4
    invoke-static {p0, p1, p2}, Loty;->a(Landroid/content/Context;Ljava/lang/CharSequence;I)Landroid/widget/Toast;
