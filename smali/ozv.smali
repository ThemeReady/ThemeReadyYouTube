...
.method public static a(Landroid/content/Context;Ljava/lang/String;Landroid/net/Uri;)V
    ...
    .prologue
    .line 15
    invoke-static {p0, p1, p2}, Lozv;->b(Landroid/content/Context;Ljava/lang/String;Landroid/net/Uri;)Landroid/content/Intent;
...
.method public static b(Landroid/content/Context;Ljava/lang/String;Landroid/net/Uri;)Landroid/content/Intent;
    ...
    .prologue
    .line 20
    invoke-static {p1}, Lozw;->e(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    .line 21
    invoke-static {p2}, Lpal;->b(Landroid/net/Uri;)Landroid/net/Uri;
    ...
    .line 24
    :cond_0
    invoke-static {p0, v0, v1}, Lozv;->e(Landroid/content/Context;Ljava/lang/String;Landroid/net/Uri;)Landroid/content/Intent;
...
.method public static c(Landroid/content/Context;Ljava/lang/String;Landroid/net/Uri;)V
    ...
    .prologue
    .line 26
    invoke-static {p0, p1, p2}, Lozv;->d(Landroid/content/Context;Ljava/lang/String;Landroid/net/Uri;)Landroid/content/Intent;
...
.method public static d(Landroid/content/Context;Ljava/lang/String;Landroid/net/Uri;)Landroid/content/Intent;
    ...
    .line 33
    :cond_0
    invoke-static {p0, p1, p2}, Lozv;->e(Landroid/content/Context;Ljava/lang/String;Landroid/net/Uri;)Landroid/content/Intent;
...
.method private static e(Landroid/content/Context;Ljava/lang/String;Landroid/net/Uri;)Landroid/content/Intent;
    ...
    .line 38
    invoke-virtual {v0, p1}, Lqc;->a(Ljava/lang/String;)Ljava/lang/String;
