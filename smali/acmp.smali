...
.method private constructor <init>(Lacpi;Lqdy;Luey;)V
    ...
    .line 8
    invoke-virtual {p2}, Lqdy;->i()Lcom/google/android/libraries/youtube/proto/nano/InnerTubeUploadsConfig;

    move-result-object v0

    iput-object v0, p0, Lacmp;->c:Lcom/google/android/libraries/youtube/proto/nano/InnerTubeUploadsConfig;

    .line 9
    iput-object p1, p0, Lacmp;->b:Lacpi;

    .line 10
    iput-object p3, p0, Lacmp;->a:Luey;

    .line 11
    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lqdy;Luey;)V
    .locals 3
    ...
    .line 3
    invoke-direct {v2}, Lacmz;-><init>()V

    .line 4
    invoke-direct {v0, p1, v1, v2}, Lacpi;-><init>(Landroid/content/Context;Ljava/lang/String;Lacph;)V

    .line 5
    invoke-direct {p0, v0, p2, p3}, Lacmp;-><init>(Lacpi;Lqdy;Luey;)V
...
.method private final a()Ljava/util/List;
    ...
    .line 28
    :try_start_0
    iget-object v0, p0, Lacmp;->b:Lacpi;

    invoke-virtual {v0}, Lacpi;->a()V

    .line 29
    new-instance v0, Ljava/util/ArrayList;

    iget-object v1, p0, Lacmp;->b:Lacpi;

    invoke-virtual {v1}, Lacpi;->c()Ljava/util/Map;
    ...
    invoke-virtual {v1}, Lacpi;->b()V
    :try_end_0
    .catch Lacpl; {:try_start_0 .. :try_end_0} :catch_0

    .line 35
    iget-object v1, p0, Lacmp;->a:Luey;
...
.method private final b()Lcom/google/android/libraries/youtube/proto/nano/InnerTubeUploadsConfig;
    ...
    .line 52
    :try_start_0
    iget-object v1, p0, Lacmp;->c:Lcom/google/android/libraries/youtube/proto/nano/InnerTubeUploadsConfig;
...
.method public final a(Landroid/os/Bundle;)V
    ...
    .line 12
    invoke-direct {p0}, Lacmp;->a()Ljava/util/List;
    ...
    invoke-virtual {v3}, Ladnp;->toString()Ljava/lang/String;
    ...
    .line 25
    :cond_1
    invoke-direct {p0}, Lacmp;->b()Lcom/google/android/libraries/youtube/proto/nano/InnerTubeUploadsConfig;
