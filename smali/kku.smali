...
.field private static volatile n:Lklz;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lkku;->l:Ljava/lang/Object;
    ...
    sput-object v0, Lkku;->n:Lklz;

    const/4 v0, 0x0

    sput-boolean v0, Lkku;->o:Z

    const-wide/16 v0, 0x0

    sput-wide v0, Lkku;->p:J
...
.method protected constructor <init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Lkks;-><init>(Landroid/content/Context;)V

    iput-boolean v0, p0, Lkku;->m:Z

    iput-object p2, p0, Lkku;->q:Ljava/lang/String;
...
.method protected constructor <init>(Landroid/content/Context;Ljava/lang/String;Z)V
    ...
    iput-boolean p3, p0, Lkku;->m:Z

    return-void
.end method

.method private static a(Lklz;Landroid/view/MotionEvent;Landroid/util/DisplayMetrics;)Lkmd;
    .locals 5
    ...
    .line 64
    invoke-virtual {p0, v0, v1}, Lklz;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/reflect/Method;
    ...
    invoke-direct {v1, v0}, Lkmd;-><init>(Ljava/lang/String;)V
    :try_end_0
...
.method protected static declared-synchronized a(Landroid/content/Context;Z)V
    ...
    :try_start_0
    sget-boolean v0, Lkku;->o:Z

    if-nez v0, :cond_0

    invoke-static {}, Lkme;->a()Ljava/lang/Long;
    ...
    sput-wide v2, Lkku;->p:J

    invoke-static {p0, p1}, Lkku;->b(Landroid/content/Context;Z)Lklz;
...
.method protected static a(Ljava/util/List;)V
    ...
    .line 148
    iget-object v1, v0, Lklz;->c:Ljava/util/concurrent/ExecutorService;
    ...
    invoke-static {v0}, Lkme;->a(Ljava/lang/Throwable;)Ljava/lang/String;
...
.method private static b(Landroid/content/Context;Z)Lklz;
    .locals 5
    ...
    sget-object v1, Lkku;->l:Ljava/lang/Object;
    ...
    .line 4
    invoke-static {p0, v0, v2, p1}, Lklz;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Z)Lklz;
    ...
    .line 8
    invoke-virtual {v0, v3, v4, v2}, Lklz;->a(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)Z
    ...
    invoke-virtual {v0, v2, v3, v4}, Lklz;->a(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)Z
...
.method protected final a([Ljava/lang/StackTraceElement;)J
    ...
    .line 157
    invoke-virtual {v0, v1, v2}, Lklz;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/reflect/Method;
    ...
    invoke-direct {v1, v0}, Lklx;-><init>(Ljava/lang/String;)V

    iget-object v0, v1, Lklx;->a:Ljava/lang/Long;
...
.method protected a(Landroid/content/Context;Landroid/view/View;)Lkjm;
    .locals 18
    ...
    invoke-direct {v6}, Lkjm;-><init>()V

    move-object/from16 v0, p0

    iget-object v2, v0, Lkku;->q:Ljava/lang/String;
    ...
    iput-object v2, v6, Lkjm;->b:Ljava/lang/String;

    :cond_0
    move-object/from16 v0, p0

    iget-boolean v2, v0, Lkku;->m:Z

    move-object/from16 v0, p1

    invoke-static {v0, v2}, Lkku;->b(Landroid/content/Context;Z)Lklz;

    move-result-object v3

    invoke-virtual {v3}, Lklz;->c()V

    .line 67
    :try_start_0
    move-object/from16 v0, p0

    iget-object v2, v0, Lkku;->a:Landroid/view/MotionEvent;

    move-object/from16 v0, p0

    iget-object v4, v0, Lkku;->k:Landroid/util/DisplayMetrics;

    invoke-static {v3, v2, v4}, Lkku;->a(Lklz;Landroid/view/MotionEvent;Landroid/util/DisplayMetrics;)Lkmd;

    move-result-object v2

    iget-object v4, v2, Lkmd;->a:Ljava/lang/Long;

    iput-object v4, v6, Lkjm;->g:Ljava/lang/Long;

    iget-object v4, v2, Lkmd;->b:Ljava/lang/Long;

    iput-object v4, v6, Lkjm;->h:Ljava/lang/Long;

    iget-object v4, v2, Lkmd;->c:Ljava/lang/Long;

    iput-object v4, v6, Lkjm;->i:Ljava/lang/Long;

    move-object/from16 v0, p0

    iget-boolean v4, v0, Lkku;->j:Z

    if-eqz v4, :cond_1

    iget-object v4, v2, Lkmd;->d:Ljava/lang/Long;

    iput-object v4, v6, Lkjm;->u:Ljava/lang/Long;

    iget-object v2, v2, Lkmd;->e:Ljava/lang/Long;

    iput-object v2, v6, Lkjm;->v:Ljava/lang/Long;

    :cond_1
    sget-object v2, Ljvk;->k:Ljve;

    invoke-virtual {v2}, Ljve;->a()Ljava/lang/Object;
    ...
    invoke-virtual {v0, v2}, Lkks;->b(Landroid/view/MotionEvent;)Lkmd;

    move-result-object v5

    iget-object v2, v5, Lkmd;->a:Ljava/lang/Long;

    iput-object v2, v4, Lkjn;->a:Ljava/lang/Long;

    iget-object v2, v5, Lkmd;->b:Ljava/lang/Long;

    iput-object v2, v4, Lkjn;->b:Ljava/lang/Long;

    iget-object v2, v5, Lkmd;->c:Ljava/lang/Long;

    iput-object v2, v4, Lkjn;->h:Ljava/lang/Long;

    move-object/from16 v0, p0

    iget-boolean v2, v0, Lkku;->j:Z

    if-eqz v2, :cond_4

    iget-object v2, v5, Lkmd;->e:Ljava/lang/Long;

    iput-object v2, v4, Lkjn;->c:Ljava/lang/Long;

    iget-object v2, v5, Lkmd;->d:Ljava/lang/Long;

    iput-object v2, v4, Lkjn;->e:Ljava/lang/Long;

    iget-object v2, v5, Lkmd;->f:Ljava/lang/Long;
    ...
    iput-object v2, v4, Lkjn;->g:Ljava/lang/Integer;

    move-object/from16 v0, p0

    iget-wide v8, v0, Lkku;->d:J
    ...
    iget-object v2, v0, Lkku;->k:Landroid/util/DisplayMetrics;

    if-eqz v2, :cond_b

    move-object/from16 v0, p0

    iget-wide v8, v0, Lkku;->i:J

    long-to-double v8, v8

    move-object/from16 v0, p0

    iget-wide v10, v0, Lkku;->d:J
    ...
    :goto_1
    iput-object v2, v4, Lkjn;->d:Ljava/lang/Long;

    move-object/from16 v0, p0

    iget-wide v8, v0, Lkku;->h:J
    ...
    iput-object v2, v4, Lkjn;->f:Ljava/lang/Long;

    :cond_3
    iget-object v2, v5, Lkmd;->i:Ljava/lang/Long;

    iput-object v2, v4, Lkjn;->j:Ljava/lang/Long;

    iget-object v2, v5, Lkmd;->j:Ljava/lang/Long;

    iput-object v2, v4, Lkjn;->i:Ljava/lang/Long;

    iget-object v2, v5, Lkmd;->k:Ljava/lang/Long;
    ...
    iput-object v2, v4, Lkjn;->k:Ljava/lang/Integer;

    move-object/from16 v0, p0

    iget-wide v8, v0, Lkku;->g:J
    ...
    iput-object v2, v4, Lkjn;->l:Ljava/lang/Long;

    :cond_4
    iput-object v4, v6, Lkjm;->I:Lkjn;
    :try_end_0
    .catch Lkld; {:try_start_0 .. :try_end_0} :catch_1

    :cond_5
    :goto_3
    move-object/from16 v0, p0

    iget-wide v4, v0, Lkku;->c:J
    ...
    iput-object v2, v6, Lkjm;->y:Ljava/lang/Long;
    ...
    iput-object v2, v6, Lkjm;->x:Ljava/lang/Long;

    :cond_7
    move-object/from16 v0, p0

    iget-wide v4, v0, Lkku;->e:J
    ...
    iput-object v2, v6, Lkjm;->w:Ljava/lang/Long;

    :cond_8
    move-object/from16 v0, p0

    iget-wide v4, v0, Lkku;->f:J
    ...
    iput-object v2, v6, Lkjm;->z:Ljava/lang/Long;

    :cond_9
    :try_start_1
    move-object/from16 v0, p0

    iget-object v2, v0, Lkku;->b:Ljava/util/LinkedList;
    ...
    new-array v2, v5, [Lkjn;

    iput-object v2, v6, Lkjm;->J:[Lkjn;
    ...
    iget-object v7, v0, Lkku;->k:Landroid/util/DisplayMetrics;

    invoke-static {v3, v2, v7}, Lkku;->a(Lklz;Landroid/view/MotionEvent;Landroid/util/DisplayMetrics;)Lkmd;

    move-result-object v2

    new-instance v7, Lkjn;

    invoke-direct {v7}, Lkjn;-><init>()V

    iget-object v8, v2, Lkmd;->a:Ljava/lang/Long;

    iput-object v8, v7, Lkjn;->a:Ljava/lang/Long;

    iget-object v2, v2, Lkmd;->b:Ljava/lang/Long;

    iput-object v2, v7, Lkjn;->b:Ljava/lang/Long;

    iget-object v2, v6, Lkjm;->J:[Lkjn;
    ...
    .line 70
    iget-object v2, v3, Lklz;->c:Ljava/util/concurrent/ExecutorService;

    .line 71
    if-eqz v2, :cond_16

    invoke-virtual {v3}, Lklz;->e()I

    move-result v7

    new-instance v2, Lkmn;

    invoke-direct {v2, v3, v6}, Lkmn;-><init>(Lklz;Lkjm;)V
    ...
    .line 74
    invoke-direct/range {v2 .. v7}, Lkmq;-><init>(Lklz;Ljava/lang/String;Ljava/lang/String;Lkjm;I)V
    ...
    invoke-direct/range {v9 .. v16}, Lkml;-><init>(Lklz;Ljava/lang/String;Ljava/lang/String;Lkjm;JI)V
    ...
    .line 80
    invoke-direct/range {v2 .. v7}, Lkmk;-><init>(Lklz;Ljava/lang/String;Ljava/lang/String;Lkjm;I)V
    ...
    .line 83
    invoke-direct/range {v2 .. v7}, Lkmg;-><init>(Lklz;Ljava/lang/String;Ljava/lang/String;Lkjm;I)V
    ...
    .line 86
    invoke-direct/range {v2 .. v7}, Lkmo;-><init>(Lklz;Ljava/lang/String;Ljava/lang/String;Lkjm;I)V

    move-object/from16 v0, v17

    invoke-interface {v0, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    sget-object v2, Ljvk;->n:Ljve;
    ...
    .line 89
    invoke-direct/range {v2 .. v7}, Lkmj;-><init>(Lklz;Ljava/lang/String;Ljava/lang/String;Lkjm;I)V
    ...
    .line 92
    invoke-direct/range {v2 .. v7}, Lkmv;-><init>(Lklz;Ljava/lang/String;Ljava/lang/String;Lkjm;I)V
    ...
    .line 95
    invoke-direct/range {v2 .. v7}, Lkmt;-><init>(Lklz;Ljava/lang/String;Ljava/lang/String;Lkjm;I)V
    ...
    invoke-direct/range {v2 .. v8}, Lkms;-><init>(Lklz;Ljava/lang/String;Ljava/lang/String;Lkjm;I[Ljava/lang/StackTraceElement;)V
    ...
    .line 101
    invoke-direct/range {v2 .. v8}, Lkmw;-><init>(Lklz;Ljava/lang/String;Ljava/lang/String;Lkjm;ILandroid/view/View;)V
    ...
    .line 102
    :cond_16
    invoke-static/range {v17 .. v17}, Lkku;->a(Ljava/util/List;)V

    .line 103
    invoke-virtual {v3}, Lklz;->d()V
...
.method protected final a(Landroid/content/Context;Lkjc;)Lkjm;
    .locals 2
    ...
    iput-object v1, v0, Lkjm;->b:Ljava/lang/String;

    :cond_0
    iget-boolean v1, p0, Lkku;->m:Z

    invoke-static {p1, v1}, Lkku;->b(Landroid/content/Context;Z)Lklz;

    move-result-object v1

    invoke-virtual {v1}, Lklz;->c()V

    invoke-virtual {p0, v1, v0, p2}, Lkku;->a(Lklz;Lkjm;Lkjc;)V

    invoke-virtual {v1}, Lklz;->d()V

    return-object v0
.end method

.method protected a(Lklz;Lkjm;Lkjc;)V
    .locals 1
    ...
    invoke-static {v0}, Lkku;->a(Ljava/util/List;)V

    goto :goto_0
.end method

.method protected b(Lklz;Lkjm;Lkjc;)Ljava/util/List;
    .locals 16

    .prologue
    .line 104
    invoke-virtual/range {p1 .. p1}, Lklz;->e()I
    ...
    .line 107
    sget-object v1, Ljvk;->g:Ljve;

    invoke-virtual {v1}, Ljve;->a()Ljava/lang/Object;
    ...
    invoke-direct/range {v0 .. v7}, Lkmi;-><init>(Lklz;Ljava/lang/String;Ljava/lang/String;Lkjm;IZLkjc;)V
    ...
    invoke-direct/range {v7 .. v14}, Lkml;-><init>(Lklz;Ljava/lang/String;Ljava/lang/String;Lkjm;JI)V
    ...
    .line 113
    invoke-direct/range {v0 .. v5}, Lkmq;-><init>(Lklz;Ljava/lang/String;Ljava/lang/String;Lkjm;I)V
    ...
    .line 116
    invoke-direct/range {v0 .. v5}, Lkmr;-><init>(Lklz;Ljava/lang/String;Ljava/lang/String;Lkjm;I)V
    ...
    .line 119
    invoke-direct/range {v0 .. v5}, Lkmu;-><init>(Lklz;Ljava/lang/String;Ljava/lang/String;Lkjm;I)V
    ...
    .line 122
    invoke-direct/range {v0 .. v5}, Lkmh;-><init>(Lklz;Ljava/lang/String;Ljava/lang/String;Lkjm;I)V
    ...
    .line 125
    invoke-direct/range {v0 .. v5}, Lkmj;-><init>(Lklz;Ljava/lang/String;Ljava/lang/String;Lkjm;I)V
    ...
    .line 128
    invoke-direct/range {v0 .. v5}, Lkmp;-><init>(Lklz;Ljava/lang/String;Ljava/lang/String;Lkjm;I)V
    ...
    .line 131
    invoke-direct/range {v0 .. v5}, Lkmg;-><init>(Lklz;Ljava/lang/String;Ljava/lang/String;Lkjm;I)V
    ...
    .line 134
    invoke-direct/range {v0 .. v5}, Lkmk;-><init>(Lklz;Ljava/lang/String;Ljava/lang/String;Lkjm;I)V
    ...
    .line 137
    invoke-direct/range {v0 .. v5}, Lkmo;-><init>(Lklz;Ljava/lang/String;Ljava/lang/String;Lkjm;I)V

    invoke-interface {v15, v0}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    sget-object v0, Ljvk;->i:Ljve;
    ...
    .line 140
    invoke-direct/range {v0 .. v5}, Lkmv;-><init>(Lklz;Ljava/lang/String;Ljava/lang/String;Lkjm;I)V

    invoke-interface {v15, v0}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    :cond_2
    sget-object v0, Ljvk;->l:Ljve;
    ...
    .line 143
    invoke-direct/range {v0 .. v5}, Lkmt;-><init>(Lklz;Ljava/lang/String;Ljava/lang/String;Lkjm;I)V
...
.method protected final b(Landroid/view/MotionEvent;)Lkmd;
    .locals 6
    ...
    iget-object v5, p0, Lkku;->k:Landroid/util/DisplayMetrics;
