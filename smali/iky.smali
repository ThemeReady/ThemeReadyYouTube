...
# direct methods
.method public constructor <init>(Landroid/view/View;Likh;Lilp;)V
    .locals 6
    ...
    .line 27
    invoke-direct/range {v0 .. v5}, Liky;-><init>(Landroid/view/View;Likh;Lilp;Landroid/os/Looper;Ljava/util/Random;)V

    .line 28
    return-void
.end method

.method private constructor <init>(Landroid/view/View;Likh;Lilp;Landroid/os/Looper;Ljava/util/Random;)V
    .locals 2
    ...
    iput-object v0, p0, Liky;->n:Landroid/view/View;
    ...
    iput-object v0, p0, Liky;->b:Ljava/util/Random;

    .line 6
    iput-boolean v1, p0, Liky;->p:Z

    .line 7
    iput-boolean v1, p0, Liky;->q:Z

    .line 8
    iput-boolean v1, p0, Liky;->r:Z
    ...
    iput-object v0, p0, Liky;->s:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Liky;->t:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Liky;->u:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Liky;->v:Landroid/graphics/Rect;
...
.method private final a(Landroid/view/View;)Z
    ...
    .line 67
    iget-object v0, p0, Liky;->n:Landroid/view/View;

    iget-object v1, p0, Liky;->s:Landroid/graphics/Rect;

    invoke-static {v0, v1}, Liky;->a(Landroid/view/View;Landroid/graphics/Rect;)V

    .line 68
    iget-object v2, p0, Liky;->n:Landroid/view/View;
    ...
    invoke-static {v0, v2, v1}, Liky;->a(Landroid/view/View;Landroid/view/ViewGroup;Landroid/graphics/Rect;)V

    .line 72
    iget-boolean v1, p0, Liky;->p:Z

    if-eqz v1, :cond_3

    .line 73
    iget-object v1, p0, Liky;->t:Landroid/graphics/Rect;
    ...
    iget-object v3, p0, Liky;->s:Landroid/graphics/Rect;
    ...
    iget-object v2, p0, Liky;->t:Landroid/graphics/Rect;

    iget-object v3, p0, Liky;->s:Landroid/graphics/Rect;

    .line 84
    invoke-static {v2, v3}, Liky;->a(Landroid/graphics/Rect;Landroid/graphics/Rect;)Ljava/lang/String;
    ...
    iput-object v0, p0, Liky;->k:Ljava/lang/String;
    ...
    .line 91
    iget-object v0, p0, Liky;->s:Landroid/graphics/Rect;
    ...
    invoke-direct/range {v0 .. v6}, Liky;->a(Landroid/view/View;Landroid/view/ViewGroup;IIII)Z
...
.method private final a(Landroid/view/View;Landroid/view/ViewGroup;IIII)Z
    ...
    .prologue
    .line 97
    iget-object v4, p0, Liky;->u:Landroid/graphics/Rect;
    ...
    invoke-static {v0, v1, v4}, Liky;->a(Landroid/view/View;Landroid/view/ViewGroup;Landroid/graphics/Rect;)V

    .line 99
    iget-object v4, p0, Liky;->v:Landroid/graphics/Rect;

    move-object/from16 v0, p1

    invoke-static {v0, v4}, Liky;->a(Landroid/view/View;Landroid/graphics/Rect;)V

    .line 100
    iget-object v4, p0, Liky;->v:Landroid/graphics/Rect;

    iget-object v5, p0, Liky;->u:Landroid/graphics/Rect;

    iget v5, v5, Landroid/graphics/Rect;->left:I

    iget-object v6, p0, Liky;->u:Landroid/graphics/Rect;
    ...
    iget-object v8, p0, Liky;->u:Landroid/graphics/Rect;

    iget-object v9, p0, Liky;->v:Landroid/graphics/Rect;
    ...
    .line 107
    invoke-static {v9, v8}, Liky;->a(Landroid/graphics/Rect;Landroid/graphics/Rect;)Ljava/lang/String;
    ...
    iput-object v4, p0, Liky;->k:Ljava/lang/String;
    ...
    .line 111
    invoke-static {v8, v9}, Liky;->a(Landroid/graphics/Rect;Landroid/graphics/Rect;)Ljava/lang/String;
    ...
    .line 142
    invoke-direct/range {v4 .. v10}, Liky;->a(Landroid/view/View;Landroid/view/ViewGroup;IIII)Z
...
.method public final a()V
    ...
    .line 29
    iget-object v0, p0, Liky;->g:Landroid/os/Handler;
...
.method public final c()Z
    ...
    .line 35
    iget-object v3, p0, Liky;->n:Landroid/view/View;
    ...
    .line 36
    iget-object v4, p0, Liky;->n:Landroid/view/View;
    ...
    iput-object v0, p0, Liky;->l:Ljava/lang/String;
...
.method public final d()Z
    ...
    iput-object v0, p0, Liky;->m:Ljava/lang/String;
...
.method public final e()Z
    ...
    .line 64
    invoke-direct {p0, v0}, Liky;->a(Landroid/view/View;)Z
