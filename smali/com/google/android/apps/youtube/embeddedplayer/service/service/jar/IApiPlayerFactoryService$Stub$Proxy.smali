...
.method public final a(Liqb;Liqt;Liqz;Lirc;Lipy;Lipv;Lirf;Liqe;Lirl;Liqq;Liqw;Liri;Liqh;Liqn;Z)Lcom/google/android/apps/youtube/embeddedplayer/service/service/jar/IApiPlayerService;
    ...
    invoke-interface {p1}, Liqb;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p2}, Liqt;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p3}, Liqz;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p4}, Lirc;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p5}, Lipy;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p6}, Lipv;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p7}, Lirf;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p8}, Liqe;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p9}, Lirl;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p10}, Liqq;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface/range {p11 .. p11}, Liqw;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface/range {p12 .. p12}, Liri;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface/range {p13 .. p13}, Liqh;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface/range {p14 .. p14}, Liqn;->asBinder()Landroid/os/IBinder;
