...
.method private init()V
    ...
    .line 8
    :try_start_0
    iget-object v0, p0, Lcom/google/vr/ndk/base/GvrLayout;->impl:Laduf;
    ...
    invoke-static {v0}, Lcom/google/vr/ndk/base/GvrLayoutFactory;->create(Landroid/content/Context;)Laduf;

    move-result-object v0

    iput-object v0, p0, Lcom/google/vr/ndk/base/GvrLayout;->impl:Laduf;

    .line 10
    :cond_0
    new-instance v0, Lcom/google/vr/ndk/base/GvrUiLayout;

    iget-object v1, p0, Lcom/google/vr/ndk/base/GvrLayout;->impl:Laduf;

    invoke-interface {v1}, Laduf;->getUiLayout()Ladui;

    move-result-object v1

    invoke-direct {v0, v1}, Lcom/google/vr/ndk/base/GvrUiLayout;-><init>(Ladui;)V
    ...
    iget-object v2, p0, Lcom/google/vr/ndk/base/GvrLayout;->impl:Laduf;

    invoke-interface {v2}, Laduf;->getNativeGvrContext()J
    ...
    invoke-interface {v0}, Laduf;->getRootView()Ladul;

    move-result-object v0

    const-class v1, Landroid/view/View;

    invoke-static {v0, v1}, Lcom/google/vr/vrcore/library/api/ObjectWrapper;->a(Ladul;Ljava/lang/Class;)Ljava/lang/Object;
...
.method public enableAsyncReprojectionProtected()Z
    ...
    invoke-interface {v0, v1}, Laduf;->enableAsyncReprojection(I)Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onPause()V
    ...
    invoke-interface {v0}, Laduf;->onPause()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public onResume()V
    ...
    invoke-interface {v0}, Laduf;->onResume()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public setPresentationView(Landroid/view/View;)V
    ...
    invoke-static {p1}, Lcom/google/vr/vrcore/library/api/ObjectWrapper;->a(Ljava/lang/Object;)Ladul;

    move-result-object v1

    invoke-interface {v0, v1}, Laduf;->setPresentationView(Ladul;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setStereoModeEnabled(Z)V
    ...
    invoke-interface {v0, p1}, Laduf;->setStereoModeEnabled(Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public shutdown()V
    ...
    invoke-interface {v0}, Laduf;->shutdown()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
