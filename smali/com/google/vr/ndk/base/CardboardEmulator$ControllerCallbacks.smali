...
# virtual methods
.method public onControllerEventPacket(Ladtn;)V
    .locals 3
    ...
    .line 14
    iget-boolean v2, v1, Ladtk;->b:Z

    if-eqz v2, :cond_0

    .line 15
    iget v1, v1, Ladtk;->a:I
...
.method public onControllerEventPacket2(Ladtp;)V
    .locals 0

    .prologue
    .line 20
    invoke-virtual {p0, p1}, Lcom/google/vr/ndk/base/CardboardEmulator$ControllerCallbacks;->onControllerEventPacket(Ladtn;)V

    .line 21
    return-void
.end method

.method public onControllerRecentered(Ladtv;)V
    .locals 0
