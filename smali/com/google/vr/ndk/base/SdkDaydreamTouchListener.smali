...
.field public final vrParamsProvider:Laeui;
...
.method public constructor <init>(Lcom/google/vr/ndk/base/GvrLayoutImpl;)V
    ...
    .line 5
    invoke-virtual {v2}, Lcom/google/vr/ndk/base/GvrApi;->getSdkConfigurationParams()Ladnn;

    move-result-object v2

    iget-object v2, v2, Ladnn;->e:Ljava/lang/Integer;
    ...
    iget-object v2, v2, Ladnn;->j:Ljava/lang/Boolean;
    ...
    .line 8
    invoke-static {v0}, Laeuj;->a(Landroid/content/Context;)Laeui;

    move-result-object v2

    iput-object v2, p0, Lcom/google/vr/ndk/base/SdkDaydreamTouchListener;->vrParamsProvider:Laeui;
    ...
    .line 10
    invoke-static {v0}, Laesr;->a(Landroid/content/Context;)Landroid/view/Display;
...
.method static synthetic access$200(Lcom/google/vr/ndk/base/SdkDaydreamTouchListener;)Laeui;
    .locals 1

    .prologue
    .line 34
    iget-object v0, p0, Lcom/google/vr/ndk/base/SdkDaydreamTouchListener;->vrParamsProvider:Laeui;
...
.method protected logEvent(ILadlk;)V
    .locals 2
    ...
    invoke-direct {v0, p2}, Laexb;-><init>(Ladlk;)V
    ...
    invoke-interface {v1, v0}, Laewz;->a(Laexb;)V
    :try_end_0
