...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 2
    iput-object p1, p0, Lbqd;->a:Landroid/content/Context;
...
.method private static a(Ljava/util/List;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 13
    invoke-static {p1}, Lbqd;->a(Ljava/lang/String;)Ljava/util/List;
...
.method private static a(ZLjava/util/List;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 17
    invoke-static {p1, p2}, Lbqd;->a(Ljava/util/List;Ljava/lang/String;)Ljava/util/List;
...
.method public final a(Lbqv;)Ljava/util/List;
    ...
    invoke-static {v0}, Lbqd;->a(Ljava/lang/String;)Ljava/util/List;

    move-result-object v0

    .line 23
    :goto_0
    invoke-static {v1, v0}, Lbqd;->a(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {v0, v1, v5}, Lbqd;->a(ZLjava/util/List;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {v0, v5, v8}, Lbqd;->a(ZLjava/util/List;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {v0, v5, v7}, Lbqd;->a(ZLjava/util/List;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {v0, v5, v6}, Lbqd;->a(ZLjava/util/List;Ljava/lang/String;)Ljava/util/List;

    move-result-object v0

    .line 38
    invoke-static {v4, v0}, Lbqd;->a(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {v0, v4}, Lbqd;->a(Ljava/util/List;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {v4}, Lbqd;->a(Ljava/lang/String;)Ljava/util/List;

    move-result-object v4

    .line 55
    :goto_5
    invoke-static {v0, v4}, Lbqd;->a(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    .line 68
    :goto_7
    invoke-static {v4, v0}, Lbqd;->a(Ljava/util/List;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 71
    :cond_b
    invoke-static {v6, v4}, Lbqd;->a(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {v2}, Lbqd;->a(Ljava/lang/String;)Ljava/util/List;

    move-result-object v2

    .line 78
    :goto_a
    invoke-static {v0, v2}, Lbqd;->a(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    .line 98
    :goto_b
    invoke-static {v2, v1}, Lbqd;->a(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    .line 82
    :cond_f
    iget-object v4, p0, Lbqd;->a:Landroid/content/Context;
    ...
    .line 89
    iget-object v7, p0, Lbqd;->a:Landroid/content/Context;
    ...
    .line 92
    :cond_12
    invoke-static {v5}, Lbqd;->a(Ljava/lang/String;)Ljava/util/List;
