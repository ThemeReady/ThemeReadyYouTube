...
.method public constructor <init>(Landroid/content/Context;Landroid/net/Uri;)V
    ...
    iput-object v0, p0, Lixs;->a:Landroid/content/Context;
    ...
    iput-object v0, p0, Lixs;->b:Landroid/net/Uri;

    .line 5
    const/4 v0, 0x0

    iput-object v0, p0, Lixs;->c:Ljava/util/Map;
...
.method private static a(Landroid/media/MediaFormat;)Liyt;
    .locals 27
    ...
    invoke-static {v0, v1}, Lixs;->a(Landroid/media/MediaFormat;Ljava/lang/String;)I
    ...
    iput-object v0, v1, Liyt;->w:Landroid/media/MediaFormat;
...
.method private final a(JZ)V
    ...
    .line 120
    :cond_0
    iput-wide p1, p0, Lixs;->k:J

    .line 121
    iput-wide p1, p0, Lixs;->l:J

    .line 122
    iget-object v1, p0, Lixs;->e:Landroid/media/MediaExtractor;

    invoke-virtual {v1, p1, p2, v0}, Landroid/media/MediaExtractor;->seekTo(JI)V

    .line 123
    :goto_0
    iget-object v1, p0, Lixs;->i:[I
...
.method public final a(IJLiyv;Liyx;)I
    ...
    .prologue
    .line 43
    iget-boolean v0, p0, Lixs;->g:Z

    invoke-static {v0}, Ljjg;->b(Z)V

    .line 44
    iget-object v0, p0, Lixs;->i:[I
    ...
    .line 50
    iget-object v0, p0, Lixs;->e:Landroid/media/MediaExtractor;
    ...
    invoke-direct {v5, v6, v1}, Ljbw;-><init>(Ljava/lang/String;[B)V

    invoke-virtual {v2, v0, v5}, Ljbv;->a(Ljava/util/UUID;Ljbw;)V
    ...
    .line 75
    iget-object v0, p5, Liyx;->b:Ljava/nio/ByteBuffer;
    ...
    iget-object v2, p5, Liyx;->b:Ljava/nio/ByteBuffer;
    ...
    .line 78
    iget-object v1, p5, Liyx;->b:Ljava/nio/ByteBuffer;
    ...
    .line 84
    iget-object v0, p5, Liyx;->a:Lixd;

    iget-object v1, p0, Lixs;->e:Landroid/media/MediaExtractor;

    .line 85
    iget-object v2, v0, Lixd;->g:Landroid/media/MediaCodec$CryptoInfo;

    invoke-virtual {v1, v2}, Landroid/media/MediaExtractor;->getSampleCryptoInfo(Landroid/media/MediaCodec$CryptoInfo;)Z

    .line 86
    iget-object v1, v0, Lixd;->g:Landroid/media/MediaCodec$CryptoInfo;
...
.method public final a(IJ)V
    ...
    :goto_1
    invoke-direct {p0, p2, p3, v1}, Lixs;->a(JZ)V
...
.method public final a(J)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lixs;->a(JZ)V
...
.method public final b()Z
    ...
    .line 10
    iget-object v0, p0, Lixs;->d:Ljava/io/IOException;
    ...
    iput-object v0, p0, Lixs;->e:Landroid/media/MediaExtractor;

    .line 13
    :try_start_0
    iget-object v0, p0, Lixs;->a:Landroid/content/Context;
    ...
    iget-object v1, p0, Lixs;->a:Landroid/content/Context;

    iget-object v2, p0, Lixs;->b:Landroid/net/Uri;
    ...
    .line 24
    iget-object v1, p0, Lixs;->f:[Liyt;

    iget-object v2, p0, Lixs;->e:Landroid/media/MediaExtractor;

    invoke-virtual {v2, v0}, Landroid/media/MediaExtractor;->getTrackFormat(I)Landroid/media/MediaFormat;

    move-result-object v2

    invoke-static {v2}, Lixs;->a(Landroid/media/MediaFormat;)Liyt;
    ...
    .line 18
    iput-object v0, p0, Lixs;->d:Ljava/io/IOException;

    goto :goto_0

    .line 26
    :cond_2
    iput-boolean v7, p0, Lixs;->g:Z
...
.method public final e()J
    ...
    .line 112
    :cond_0
    iget-object v4, p0, Lixs;->e:Landroid/media/MediaExtractor;
