...
# direct methods
.method constructor <init>(Lkbx;Ljava/lang/String;Ljava/lang/String;)V
    .locals 0

    iput-object p2, p0, Ljxv;->a:Ljava/lang/String;

    iput-object p3, p0, Ljxv;->b:Ljava/lang/String;
...
.method public final a(Ljzn;)V
    ...
    .line 2
    :cond_1
    invoke-static {v0}, Ljzu;->a(Ljava/lang/String;)V

    invoke-virtual {p1}, Ljzn;->g()V

    iget-object v2, p1, Ljzn;->f:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    :try_start_2
    iget-object v4, p1, Ljzn;->g:Ljava/util/Map;
    ...
    invoke-interface {v4, v0, v1, v2, v3}, Ljzx;->a(Ljava/lang/String;Ljava/lang/String;J)V
    :try_end_2
    ...
    :try_start_3
    iget-object v1, p1, Ljzn;->g:Ljava/util/Map;
