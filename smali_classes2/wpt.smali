...
.method constructor <init>(Ljava/security/Key;)V
    ...
    .line 2
    iput-object p1, p0, Lwpt;->a:Ljava/security/Key;
...
.method protected final a(Landroid/net/Uri;Lorg/apache/http/Header;Lorg/apache/http/HttpResponse;)V
    ...
    .line 15
    invoke-virtual {v4, p3}, Lwpe;->a(Lorg/apache/http/HttpResponse;)Z
    ...
    iget-wide v2, v4, Lwpe;->a:J

    iget-wide v4, v4, Lwpe;->b:J

    iget-object v6, p0, Lwpt;->a:Ljava/security/Key;

    invoke-direct/range {v0 .. v6}, Lwpr;-><init>(Ljava/io/File;JJLjava/security/Key;)V
