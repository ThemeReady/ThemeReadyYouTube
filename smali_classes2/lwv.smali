...
# direct methods
.method public constructor <init>(Lcom/google/android/libraries/social/silentfeedback/nobinder/SilentFeedbackReceiver;Lkbx;Landroid/content/Intent;Landroid/content/BroadcastReceiver$PendingResult;)V
    .locals 0

    .prologue
    .line 1
    iput-object p1, p0, Llwv;->d:Lcom/google/android/libraries/social/silentfeedback/nobinder/SilentFeedbackReceiver;

    iput-object p2, p0, Llwv;->a:Lkbx;

    iput-object p3, p0, Llwv;->c:Landroid/content/Intent;

    iput-object p4, p0, Llwv;->b:Landroid/content/BroadcastReceiver$PendingResult;
...
.method public final a(Landroid/os/Bundle;)V
    ...
    .prologue
    .line 2
    iget-object v0, p0, Llwv;->a:Lkbx;

    iget-object v1, p0, Llwv;->c:Landroid/content/Intent;

    .line 4
    new-instance v2, Lkgi;

    invoke-direct {v2}, Lkgi;-><init>()V
    ...
    .line 7
    iput-object v3, v2, Lkgh;->c:Ljava/lang/String;

    .line 9
    const/4 v3, 0x1

    iput-boolean v3, v2, Lkgh;->e:Z
    ...
    .line 12
    iget-object v4, v2, Lkgi;->f:Landroid/app/ApplicationErrorReport;
    ...
    .line 30
    iput-object v1, v2, Lkgh;->d:Ljava/lang/String;

    .line 31
    :cond_6
    invoke-virtual {v2}, Lkgh;->a()Lcom/google/android/gms/feedback/FeedbackOptions;

    move-result-object v1

    .line 32
    invoke-static {v0, v1}, Lkgc;->b(Lkbx;Lcom/google/android/gms/feedback/FeedbackOptions;)Lkcb;

    move-result-object v0

    new-instance v1, Llww;

    invoke-direct {v1, p0}, Llww;-><init>(Llwv;)V
