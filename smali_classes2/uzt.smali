...
# direct methods
.method private constructor <init>(Ljava/security/Key;Ljnp;Ljnp;Loxi;ZZ)V
    .locals 3
    ...
    invoke-direct {p0, p1, p2, p5, v0}, Lwob;-><init>(Ljava/security/Key;Ljnp;ZZ)V
    ...
    invoke-direct {v1, p4, p3}, Lvas;-><init>(Loxi;Ljnp;)V

    .line 26
    iget-object v2, p0, Lwob;->c:Lorg/apache/http/protocol/HttpRequestHandlerRegistry;
...
.method public static a(Ljava/security/Key;Ljnp;Ljnp;Loxi;Z)Luzt;
    .locals 8
    ...
    invoke-direct/range {v0 .. v6}, Luzt;-><init>(Ljava/security/Key;Ljnp;Ljnp;Loxi;ZZ)V
    ...
    iput-object v1, v0, Lwob;->f:Ljava/net/ServerSocket;

    .line 5
    iget-object v2, v0, Lwob;->f:Ljava/net/ServerSocket;

    new-instance v3, Ljava/net/InetSocketAddress;

    iget-boolean v1, v0, Lwob;->e:Z
    ...
    iput-object v1, v0, Lwob;->g:Ljava/util/concurrent/ExecutorService;

    .line 11
    iget-object v1, v0, Lwob;->g:Ljava/util/concurrent/ExecutorService;

    new-instance v2, Lwoc;

    invoke-direct {v2, v0}, Lwoc;-><init>(Lwob;)V
...
.method public final a(Ljava/lang/String;ILjava/lang/String;JJJ)Landroid/net/Uri;
    ...
    invoke-virtual/range {v3 .. v11}, Lwob;->a(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;JJ)Lwod;
    ...
    invoke-virtual {v2, v3, v0, v1}, Lwod;->a(Ljava/lang/String;J)Lwod;

    move-result-object v2

    .line 30
    invoke-virtual {v2}, Lwod;->a()Landroid/net/Uri;
