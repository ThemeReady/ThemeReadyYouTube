...
# virtual methods
.method public final a(Lfnc;Lfng;)V
    .locals 6

    .prologue
    .line 131
    iget-object v1, p0, Lcom/google/android/apps/youtube/app/settings/developer/DebugForceInnertubeCapabilitiesActivity;->f:Lfnl;

    .line 132
    iget-object v2, p1, Lfnc;->d:Ljava/lang/String;

    .line 134
    iget-object v3, p2, Lfng;->c:Ljava/lang/String;

    .line 136
    iget-object v0, v1, Lfnl;->b:Landroid/content/SharedPreferences;
    ...
    .line 137
    invoke-static {v0}, Lfnl;->a(Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-static {v4}, Lfnl;->a(Ljava/util/Map;)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v1, v0, v2}, Lfnl;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method protected final f()V
    ...
    .line 48
    invoke-interface {v0, p0}, Lfmw;->a(Lcom/google/android/apps/youtube/app/settings/developer/DebugForceInnertubeCapabilitiesActivity;)V
...
.method public final g()V
    ...
    .line 59
    iget-object v0, p0, Lcom/google/android/apps/youtube/app/settings/developer/DebugForceInnertubeCapabilitiesActivity;->f:Lfnl;
    ...
    iget-object v1, p0, Lcom/google/android/apps/youtube/app/settings/developer/DebugForceInnertubeCapabilitiesActivity;->j:Lfnd;

    invoke-direct {v9, v1, p0}, Lfnc;-><init>(Lfnd;Landroid/content/Context;)V
    ...
    .line 67
    invoke-virtual {v9, v8}, Lfnc;->a(Ljava/lang/String;)V

    .line 68
    invoke-virtual {v9}, Lfnc;->a()V
    ...
    .line 72
    iget-object v1, v1, Lfnl;->b:Landroid/content/SharedPreferences;
    ...
    .line 73
    invoke-static {v1}, Lfnl;->a(Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-direct {v12, v9, v1}, Lfng;-><init>(Lfnc;Z)V

    .line 93
    iget-object v1, v9, Lfnc;->b:Ljava/util/List;

    .line 94
    invoke-interface {v1, v12}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 95
    invoke-virtual {v12, v11}, Lfng;->a(Ljava/lang/String;)V

    .line 96
    invoke-virtual {v12}, Lfng;->a()V
    ...
    .line 99
    :cond_3
    iget-object v0, p0, Lcom/google/android/apps/youtube/app/settings/developer/DebugForceInnertubeCapabilitiesActivity;->h:Lfne;
    ...
    invoke-direct {v2, p0, v4, v5}, Lfnn;-><init>(Landroid/app/Activity;J)V
    ...
    .line 119
    invoke-virtual {v0, v1}, Lfnf;->a(Z)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-direct {v0, v2, v3}, Lfne;-><init>(Landroid/content/Context;Ljava/util/List;)V

    iput-object v0, p0, Lcom/google/android/apps/youtube/app/settings/developer/DebugForceInnertubeCapabilitiesActivity;->h:Lfne;
    ...
    invoke-direct {v0, v2}, Lfnj;-><init>(Landroid/view/ViewGroup;)V

    .line 16
    iget-object v2, p0, Lcom/google/android/apps/youtube/app/settings/developer/DebugForceInnertubeCapabilitiesActivity;->h:Lfne;

    invoke-virtual {v0, v2}, Lfnj;->a(Landroid/widget/ListAdapter;)V
    ...
    invoke-direct {v2, p0}, Lfmy;-><init>(Lcom/google/android/apps/youtube/app/settings/developer/DebugForceInnertubeCapabilitiesActivity;)V
    ...
    invoke-direct {v2, p0}, Lfmz;-><init>(Lcom/google/android/apps/youtube/app/settings/developer/DebugForceInnertubeCapabilitiesActivity;)V
    ...
    invoke-direct {v2, p0}, Lfna;-><init>(Lcom/google/android/apps/youtube/app/settings/developer/DebugForceInnertubeCapabilitiesActivity;)V
    ...
    invoke-direct {v0, p0}, Lfnb;-><init>(Lcom/google/android/apps/youtube/app/settings/developer/DebugForceInnertubeCapabilitiesActivity;)V

    iput-object v0, p0, Lcom/google/android/apps/youtube/app/settings/developer/DebugForceInnertubeCapabilitiesActivity;->j:Lfnd;

    .line 22
    iget-object v0, p0, Lcom/google/android/apps/youtube/app/settings/developer/DebugForceInnertubeCapabilitiesActivity;->f:Lfnl;

    .line 23
    sget-boolean v2, Lfpk;->a:Z

    if-nez v2, :cond_0

    .line 24
    invoke-virtual {v0}, Lfnl;->a()Z
    ...
    sput-object v0, Lfpk;->b:Ljava/util/Map;
    ...
    .line 29
    invoke-static {}, Lfpk;->a()V

    .line 31
    :cond_0
    const-class v0, Lyvc;

    invoke-static {v0}, Lfpk;->a(Ljava/lang/Class;)Ljava/lang/Integer;
    ...
    .line 35
    iget-object v1, p0, Lcom/google/android/apps/youtube/app/settings/developer/DebugForceInnertubeCapabilitiesActivity;->h:Lfne;
    ...
    .line 42
    :goto_1
    iput-object v0, v1, Lfne;->a:[Ljava/lang/String;
    ...
    .line 38
    :cond_3
    sget-object v0, Lfpk;->c:[Ljava/lang/String;

    if-nez v0, :cond_4

    .line 39
    sget-object v0, Lfpk;->b:Ljava/util/Map;

    invoke-interface {v0}, Ljava/util/Map;->keySet()Ljava/util/Set;

    move-result-object v0

    sget-object v2, Lfpk;->b:Ljava/util/Map;
