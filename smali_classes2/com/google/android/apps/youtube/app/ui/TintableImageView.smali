...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-static {p1, v0, v1}, Lozs;->a(Landroid/content/Context;Landroid/util/AttributeSet;I)Landroid/content/Context;
...
.method public setImageDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 26
    :cond_1
    iget-object v0, p0, Lcom/google/android/apps/youtube/app/ui/TintableImageView;->c:Ldbv;
    ...
    iput-object v0, p0, Lcom/google/android/apps/youtube/app/ui/TintableImageView;->c:Ldbv;
    ...
    .line 33
    iget-object v1, v0, Ldbv;->b:Landroid/content/res/ColorStateList;

    if-nez v1, :cond_3

    .line 34
    iget-object v1, v0, Ldbv;->a:Landroid/content/Context;

    const v2, 0x7f0100c6

    invoke-static {v1, v2, v3}, Lozs;->a(Landroid/content/Context;II)I
    ...
    .line 36
    iget-object v2, v0, Ldbv;->a:Landroid/content/Context;

    const v3, 0x7f010007

    invoke-static {v2, v3, v1}, Lozs;->a(Landroid/content/Context;II)I
    ...
    iput-object v1, v0, Ldbv;->b:Landroid/content/res/ColorStateList;

    .line 38
    :cond_3
    iget-object v0, v0, Ldbv;->b:Landroid/content/res/ColorStateList;

    .line 39
    sget-object v1, Landroid/graphics/PorterDuff$Mode;->SRC_IN:Landroid/graphics/PorterDuff$Mode;

    invoke-static {p1, v0, v1}, Ldbv;->b(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, p1, v1}, Ldbv;->a(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)Landroid/graphics/drawable/Drawable;
