...
.field private s:Lacul;

.field private t:Lizf;
...
.field private z:Liys;


# direct methods
.method public constructor <init>(Landroid/content/Context;Lacuq;)V
    .locals 4
    ...
    invoke-direct {v0, p0}, Lacum;-><init>(Lcom/google/android/moxie/common/player/VideoPlayer;)V
    ...
    invoke-direct {v0, p0}, Lacun;-><init>(Lcom/google/android/moxie/common/player/VideoPlayer;)V
    ...
    invoke-direct {v0, p0}, Lacuo;-><init>(Lcom/google/android/moxie/common/player/VideoPlayer;)V

    iput-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->y:Lixo;

    .line 9
    new-instance v0, Lacup;

    invoke-direct {v0}, Lacup;-><init>()V

    iput-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->z:Liys;

    .line 10
    iput-object p1, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->f:Landroid/content/Context;

    .line 11
    iput-object p2, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->b:Lacuq;
    ...
    iput-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->g:Lixl;

    .line 13
    iget-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->g:Lixl;

    iget-object v1, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->y:Lixo;
    ...
    invoke-interface {v0, v3}, Lixl;->a(Z)V

    .line 15
    new-instance v0, Ljkf;

    iget-object v1, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->g:Lixl;

    invoke-direct {v0, v1}, Ljkf;-><init>(Lixl;)V

    iput-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->k:Ljkf;
...
.method public static create(Landroid/content/Context;Lacuq;)Lcom/google/android/moxie/common/player/VideoPlayer;
    .locals 1
    ...
    invoke-direct {v0, p0, p1}, Lcom/google/android/moxie/common/player/VideoPlayer;-><init>(Landroid/content/Context;Lacuq;)V
...
.method public close()V
    ...
    .line 86
    iput-object v2, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->t:Lizf;
...
.method public getPlayerControl()Ljkf;
    .locals 1

    .prologue
    .line 155
    iget-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->k:Ljkf;
...
.method public open(Ljava/lang/String;I)V
    ...
    iput-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->s:Lacul;
    ...
    iget-object v3, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->s:Lacul;

    iget-object v6, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->z:Liys;

    invoke-static/range {v0 .. v6}, Lacur;->a(Landroid/content/Context;Landroid/os/Handler;Ljava/lang/String;Lixu;Ljava/lang/String;ILiys;)Lacur;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->t:Lizf;

    .line 66
    iget-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->t:Lizf;
    ...
    iget-object v1, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->t:Lizf;

    iget-object v2, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->n:Landroid/view/Surface;

    invoke-interface {v0, v1, v7, v2}, Lixl;->a(Lixm;ILjava/lang/Object;)V

    .line 69
    iget-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->g:Lixl;

    new-array v1, v7, [Lizf;

    iget-object v2, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->t:Lizf;
...
.method public pause()V
    ...
    .line 110
    iget-object v0, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->s:Lacul;
...
.method public play(JJZ)V
    ...
    .line 96
    :cond_1
    iget-object v2, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->g:Lixl;

    invoke-interface {v2}, Lixl;->f()J
...
.method public update(J)Z
    ...
    .line 136
    :cond_1
    iget-object v1, p0, Lcom/google/android/moxie/common/player/VideoPlayer;->s:Lacul;
    ...
    .line 138
    iput-wide v2, v1, Lacul;->a:J

    .line 139
    invoke-static {v2, v3}, Lacul;->a(J)J

    move-result-wide v2

    iput-wide v2, v1, Lacul;->b:J
