...
.field private i:Lacyb;

.field private j:Lacxz;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/android/moxie/common/AnalyticsManager;->i:Lacyb;
    ...
    .line 10
    iput-object v0, p0, Lcom/google/android/moxie/common/AnalyticsManager;->j:Lacxz;
...
.method public getDatapointNameList()Ljava/util/ArrayList;
    ...
    .line 88
    iget-object v0, v0, Lacxy;->a:Ljava/lang/String;
...
.method public getDatapointTimeList()Ljava/util/ArrayList;
    ...
    .line 83
    iget-object v0, v0, Lacxy;->b:Ljava/lang/Integer;
...
.method public getPlayback()Ladbx;
    .locals 15

    .prologue
    .line 91
    invoke-static {}, Lacya;->a()Lacya;

    move-result-object v0

    iget-wide v12, v0, Lacya;->c:J
    ...
    iget-object v1, v4, Lacya;->a:Ljava/lang/String;

    iget-wide v2, v4, Lacya;->b:J

    iget-wide v4, v4, Lacya;->c:J

    invoke-direct/range {v0 .. v5}, Ladbw;-><init>(Ljava/lang/String;JJ)V
    ...
    invoke-direct {v1, v0, v8}, Ladbv;-><init>(Ljava/lang/String;Ljava/util/List;)V
    ...
    iget-object v1, p0, Lcom/google/android/moxie/common/AnalyticsManager;->j:Lacxz;

    iget v1, v1, Lacxz;->a:I

    iget-object v2, p0, Lcom/google/android/moxie/common/AnalyticsManager;->j:Lacxz;

    iget-object v2, v2, Lacxz;->b:Ljava/lang/String;

    iget-object v3, p0, Lcom/google/android/moxie/common/AnalyticsManager;->j:Lacxz;

    iget v3, v3, Lacxz;->c:I

    iget-object v4, p0, Lcom/google/android/moxie/common/AnalyticsManager;->j:Lacxz;

    iget v4, v4, Lacxz;->d:I

    iget-object v5, p0, Lcom/google/android/moxie/common/AnalyticsManager;->j:Lacxz;

    iget v5, v5, Lacxz;->e:I

    iget-object v6, p0, Lcom/google/android/moxie/common/AnalyticsManager;->j:Lacxz;

    iget v6, v6, Lacxz;->f:I

    iget-object v7, p0, Lcom/google/android/moxie/common/AnalyticsManager;->j:Lacxz;

    iget-object v7, v7, Lacxz;->g:Ljava/lang/String;

    const-wide/16 v8, 0x0

    iget-object v10, p0, Lcom/google/android/moxie/common/AnalyticsManager;->j:Lacxz;

    iget-object v10, v10, Lacxz;->h:Ljava/lang/String;

    iget-object v11, p0, Lcom/google/android/moxie/common/AnalyticsManager;->j:Lacxz;

    iget-object v11, v11, Lacxz;->i:Ljava/lang/String;

    invoke-direct/range {v0 .. v11}, Ladbu;-><init>(ILjava/lang/String;IIIILjava/lang/String;JLjava/lang/String;Ljava/lang/String;)V

    .line 105
    new-instance v1, Ladcj;

    iget-object v2, p0, Lcom/google/android/moxie/common/AnalyticsManager;->i:Lacyb;

    iget-boolean v2, v2, Lacyb;->a:Z

    invoke-static {v2}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object v2

    iget-object v3, p0, Lcom/google/android/moxie/common/AnalyticsManager;->i:Lacyb;

    iget v3, v3, Lacyb;->b:F

    iget-object v4, p0, Lcom/google/android/moxie/common/AnalyticsManager;->i:Lacyb;

    iget v4, v4, Lacyb;->c:F

    iget-object v5, p0, Lcom/google/android/moxie/common/AnalyticsManager;->i:Lacyb;

    iget v5, v5, Lacyb;->d:F

    iget-object v6, p0, Lcom/google/android/moxie/common/AnalyticsManager;->i:Lacyb;

    iget v6, v6, Lacyb;->e:F

    iget-object v7, p0, Lcom/google/android/moxie/common/AnalyticsManager;->i:Lacyb;

    iget v7, v7, Lacyb;->f:F

    invoke-direct/range {v1 .. v7}, Ladcj;-><init>(Ljava/lang/Boolean;FFFFF)V
    ...
    invoke-direct/range {v3 .. v8}, Ladbx;-><init>(JLjava/util/Map;Ladbu;Ladcj;)V
...
.method public pushNewDatapoint(Ljava/lang/String;)V
    ...
    invoke-direct {v4, v5, v6}, Lacxy;-><init>(Ljava/lang/String;Ljava/lang/Integer;)V
...
.method public pushNewFsmState(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v2, v1, p2}, Lacya;-><init>(Lacya;Ljava/lang/String;)V
...
.method public setAverageDownloadSpeed(F)V
    ...
    .prologue
    .line 45
    iget-object v0, p0, Lcom/google/android/moxie/common/AnalyticsManager;->i:Lacyb;

    iput p1, v0, Lacyb;->f:F
...
.method public setEngineStats(IIIIILjava/lang/String;)V
    ...
    .prologue
    .line 51
    iget-object v0, p0, Lcom/google/android/moxie/common/AnalyticsManager;->j:Lacxz;

    iput p1, v0, Lacxz;->a:I

    .line 52
    iget-object v0, p0, Lcom/google/android/moxie/common/AnalyticsManager;->j:Lacxz;

    iput p2, v0, Lacxz;->c:I

    .line 53
    iget-object v0, p0, Lcom/google/android/moxie/common/AnalyticsManager;->j:Lacxz;

    iput p3, v0, Lacxz;->d:I

    .line 54
    iget-object v0, p0, Lcom/google/android/moxie/common/AnalyticsManager;->j:Lacxz;

    iput p4, v0, Lacxz;->e:I

    .line 55
    iget-object v0, p0, Lcom/google/android/moxie/common/AnalyticsManager;->j:Lacxz;

    iput p5, v0, Lacxz;->f:I

    .line 56
    iget-object v0, p0, Lcom/google/android/moxie/common/AnalyticsManager;->j:Lacxz;

    iput-object p6, v0, Lacxz;->g:Ljava/lang/String;
...
.method public setFpsStats(FFF)V
    ...
    iput p1, v0, Lacyb;->c:F

    .line 42
    iget-object v0, p0, Lcom/google/android/moxie/common/AnalyticsManager;->i:Lacyb;

    iput p2, v0, Lacyb;->d:F

    .line 43
    iget-object v0, p0, Lcom/google/android/moxie/common/AnalyticsManager;->i:Lacyb;

    iput p3, v0, Lacyb;->e:F
...
.method public setPackageStats(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p1, v0, Lacxz;->b:Ljava/lang/String;

    .line 48
    iget-object v0, p0, Lcom/google/android/moxie/common/AnalyticsManager;->j:Lacxz;

    iput-object p2, v0, Lacxz;->h:Ljava/lang/String;

    .line 49
    iget-object v0, p0, Lcom/google/android/moxie/common/AnalyticsManager;->j:Lacxz;

    iput-object p3, v0, Lacxz;->i:Ljava/lang/String;
...
.method public stop()V
    ...
    invoke-direct {v1, v2, v3}, Lacxy;-><init>(Ljava/lang/String;Ljava/lang/Integer;)V
    ...
    .line 27
    invoke-virtual {v0, v2, v3}, Lacya;->a(J)V
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lacxy;->toString()Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lacya;->toString()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lacya;->toString()Ljava/lang/String;
...
.method public userSetVr(Z)V
    ...
    iget-boolean v1, v0, Lacyb;->a:Z

    or-int/2addr v1, p1

    iput-boolean v1, v0, Lacyb;->a:Z
