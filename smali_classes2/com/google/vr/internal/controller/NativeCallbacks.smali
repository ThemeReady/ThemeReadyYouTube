...
.method private final a(Laevt;)V
    .locals 11
    ...
    .line 42
    :cond_1
    iget-object v1, p1, Laevt;->b:[Laevm;
    ...
    iget-wide v4, v1, Laevm;->d:J

    iget v6, v1, Laevm;->a:F

    iget v7, v1, Laevm;->b:F

    iget v8, v1, Laevm;->c:F
    ...
    iget-wide v4, v1, Laevq;->d:J

    iget v6, v1, Laevq;->a:I

    iget-boolean v7, v1, Laevq;->b:Z
    ...
    .line 58
    :cond_5
    iget-object v1, p1, Laevt;->e:[Laevx;
    ...
    iget-wide v4, v1, Laevx;->d:J

    iget v6, v1, Laevx;->a:F

    iget v7, v1, Laevx;->b:F

    iget v8, v1, Laevx;->c:F
    ...
    .line 68
    :cond_8
    iget-object v1, p1, Laevt;->g:[Laewb;
    ...
    iget-wide v4, v1, Laewb;->d:J

    iget v6, v1, Laewb;->a:F

    iget v7, v1, Laewb;->b:F

    iget v8, v1, Laewb;->c:F

    iget v9, v1, Laewb;->e:F
    ...
    .line 78
    :cond_9
    iget-object v0, p1, Laevt;->i:[Laewf;
    ...
    iget-wide v4, v0, Laewf;->d:J

    iget v6, v0, Laewf;->a:I

    iget v7, v0, Laewf;->b:F

    iget v8, v0, Laewf;->c:F
...
.method public final declared-synchronized onControllerEventPacket(Laevt;)V
    .locals 1
    ...
    :cond_0
    :try_start_1
    invoke-direct {p0, p1}, Lcom/google/vr/internal/controller/NativeCallbacks;->a(Laevt;)V
    :try_end_1
...
.method public final declared-synchronized onControllerEventPacket2(Laevv;)V
    .locals 9
    ...
    :cond_3
    :try_start_2
    iget-object v1, p1, Laevv;->k:[Laewd;
    ...
    iget-wide v4, v1, Laewd;->d:J

    iget v6, v1, Laewd;->a:F

    iget v7, v1, Laewd;->b:F

    iget v8, v1, Laewd;->c:F
    ...
    .line 32
    :cond_5
    iget-object v0, p1, Laevv;->m:Laevo;

    .line 34
    iget-wide v2, p0, Lcom/google/vr/internal/controller/NativeCallbacks;->a:J

    iget-wide v4, v0, Laevo;->d:J

    iget-boolean v6, v0, Laevo;->b:Z

    iget v7, v0, Laevo;->a:I
...
.method public final declared-synchronized onControllerRecentered(Laewb;)V
    .locals 10
    ...
    iget-wide v4, p1, Laewb;->d:J

    iget v6, p1, Laewb;->a:F

    iget v7, p1, Laewb;->b:F

    iget v8, p1, Laewb;->c:F

    iget v9, p1, Laewb;->e:F
