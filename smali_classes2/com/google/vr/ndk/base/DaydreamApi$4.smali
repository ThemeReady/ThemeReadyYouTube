...
.field public final synthetic val$callbacks:Laevh;


# direct methods
.method constructor <init>(Lcom/google/vr/ndk/base/DaydreamApi;Laevh;)V
    .locals 0
    ...
    iput-object p2, p0, Lcom/google/vr/ndk/base/DaydreamApi$4;->val$callbacks:Laevh;
...
.method public run()V
    ...
    iget-object v2, p0, Lcom/google/vr/ndk/base/DaydreamApi$4;->val$callbacks:Laevh;

    invoke-interface {v0, v2}, Laevf;->a(Laevh;)Z
    :try_end_0
    ...
    .line 10
    :try_start_1
    iget-object v0, p0, Lcom/google/vr/ndk/base/DaydreamApi$4;->val$callbacks:Laevh;

    invoke-interface {v0}, Laevh;->onTransitionComplete()V
    :try_end_1
