...
.field private synthetic b:Lsoo;


# direct methods
.method constructor <init>(Lsoo;Ljava/net/MulticastSocket;)V
    .locals 0

    .prologue
    .line 1
    iput-object p1, p0, Lsor;->b:Lsoo;

    iput-object p2, p0, Lsor;->a:Ljava/net/MulticastSocket;
...
.method public final run()V
    ...
    .line 2
    iget-object v5, p0, Lsor;->b:Lsoo;

    iget-object v6, p0, Lsor;->a:Ljava/net/MulticastSocket;
    ...
    .line 29
    invoke-static {v0, v9}, Lsoo;->a(Ljava/lang/String;Ljava/util/Map;)V
    ...
    .line 8
    sget-object v2, Lsoo;->a:Ljava/lang/String;
    ...
    .line 22
    sget-object v3, Lsoo;->a:Ljava/lang/String;

    const-string v12, "Error receiving m search response packet"

    invoke-static {v3, v12, v1}, Loyr;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    .line 35
    :cond_5
    iget-object v1, v5, Lsoo;->d:Ljava/util/Set;
    ...
    .line 37
    iget-object v1, v5, Lsoo;->e:Ljava/util/Map;
    ...
    invoke-virtual {v5, v0, v1, v9}, Lsoo;->a(Ljava/lang/String;Lstc;Ljava/util/Map;)V

    goto :goto_4

    .line 39
    :cond_6
    iget-object v1, v5, Lsoo;->b:Ljava/util/concurrent/ScheduledExecutorService;

    new-instance v10, Lsoq;

    invoke-direct {v10, v5, v0, v9, v8}, Lsoq;-><init>(Lsoo;Ljava/lang/String;Ljava/util/Map;[B)V
    ...
    .line 54
    invoke-static {v2}, Lsoo;->a(Ljava/util/List;)V
    ...
    .line 57
    sget-object v5, Lsoo;->a:Ljava/lang/String;

    const-string v8, "Error waiting for reading device description task to complete"

    invoke-static {v5, v8, v1}, Loyr;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
