...
# instance fields
.field public V:Labmy;

.field public W:Labgi;
...
.field private aa:Lxpk;

.field private ab:Laauv;
...
.method private final a(Landroid/widget/TextView;Lxpq;Ljava/util/Map;)Labmx;
    .locals 3

    .prologue
    .line 80
    iget-object v0, p0, Lobc;->V:Labmy;
    ...
    .line 84
    :goto_0
    iget-object v2, p0, Lobc;->Y:Lsex;

    invoke-virtual {v1, v0, v2, p3}, Labmv;->a(Lxpk;Lsex;Ljava/util/Map;)V
...
.method public static a(Laauv;)Lobc;
    .locals 4
...
.method public final a(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    .line 38
    new-instance v1, Laauv;

    invoke-direct {v1}, Laauv;-><init>()V
    ...
    .line 39
    iput-object v0, p0, Lobc;->ab:Laauv;
    :try_end_0
    .catch Ladno; {:try_start_0 .. :try_end_0} :catch_0

    .line 42
    :goto_0
    iget-object v0, p0, Lobc;->ab:Laauv;
    ...
    .line 54
    iget-object v9, p0, Lobc;->ab:Laauv;

    iget-object v9, v9, Laauv;->f:Lxpq;

    invoke-direct {p0, v4, v9, v6}, Lobc;->a(Landroid/widget/TextView;Lxpq;Ljava/util/Map;)Labmx;

    .line 55
    iget-object v4, p0, Lobc;->ab:Laauv;

    iget-object v4, v4, Laauv;->e:Lxpq;

    .line 56
    invoke-direct {p0, v5, v4, v8}, Lobc;->a(Landroid/widget/TextView;Lxpq;Ljava/util/Map;)Labmx;

    .line 58
    iget-object v4, p0, Lobc;->ab:Laauv;

    iget-object v4, v4, Laauv;->f:Lxpq;
    ...
    invoke-virtual {v4, v5}, Lxpq;->a(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    :goto_2
    iput-object v4, p0, Lobc;->aa:Lxpk;

    .line 59
    iget-object v4, p0, Lobc;->ab:Laauv;

    .line 60
    iget-object v5, v4, Laauv;->g:Landroid/text/Spanned;

    if-nez v5, :cond_2

    .line 61
    iget-object v5, v4, Laauv;->b:Lyop;
    ...
    iput-object v5, v4, Laauv;->g:Landroid/text/Spanned;

    .line 63
    :cond_2
    iget-object v4, v4, Laauv;->g:Landroid/text/Spanned;

    .line 64
    invoke-static {v1, v4}, Lowf;->a(Landroid/widget/TextView;Ljava/lang/CharSequence;)V

    .line 65
    iget-object v1, p0, Lobc;->ab:Laauv;

    iget-object v4, p0, Lobc;->X:Lylp;

    .line 66
    iget-object v5, v1, Laauv;->h:Landroid/text/Spanned;

    if-nez v5, :cond_3

    .line 67
    iget-object v5, v1, Laauv;->c:Lyop;

    .line 68
    invoke-static {v5, v4, v10}, Lyou;->a(Lyop;Lylp;Z)Landroid/text/Spanned;

    move-result-object v4

    iput-object v4, v1, Laauv;->h:Landroid/text/Spanned;

    .line 69
    :cond_3
    iget-object v1, v1, Laauv;->h:Landroid/text/Spanned;
    ...
    iget-object v2, p0, Lobc;->X:Lylp;

    .line 72
    iget-object v4, v1, Laauv;->i:Landroid/text/Spanned;

    if-nez v4, :cond_4

    .line 73
    iget-object v4, v1, Laauv;->d:Lyop;

    .line 74
    invoke-static {v4, v2, v10}, Lyou;->a(Lyop;Lylp;Z)Landroid/text/Spanned;

    move-result-object v2

    iput-object v2, v1, Laauv;->i:Landroid/text/Spanned;

    .line 75
    :cond_4
    iget-object v1, v1, Laauv;->i:Landroid/text/Spanned;

    .line 76
    invoke-static {v3, v1}, Lowf;->a(Landroid/widget/TextView;Ljava/lang/CharSequence;)V

    .line 77
    iget-object v1, p0, Lobc;->W:Labgi;

    iget-object v2, p0, Lobc;->ab:Laauv;

    iget-object v2, v2, Laauv;->a:Laasd;

    invoke-interface {v1, v0, v2}, Labgi;->a(Landroid/widget/ImageView;Laasd;)V

    .line 78
    iget-object v0, p0, Lobc;->Z:Lnyf;

    invoke-virtual {v0, p0}, Lnyf;->a(Lnyg;)V
...
.method public final a(Lxpk;)V
    ...
    iget-object v0, p0, Lobc;->aa:Lxpk;

    .line 99
    invoke-virtual {p1, v0}, Lxpk;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v0, v0, Lxvx;->aW:Laaus;
...
.method public final b(Landroid/os/Bundle;)V
    ...
    invoke-interface {v0, p0}, Lobd;->a(Lobc;)V
