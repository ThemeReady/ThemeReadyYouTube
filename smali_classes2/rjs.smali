...
.method public constructor <init>(D)V
    ...
    invoke-direct {v0, v1}, Lrjy;-><init>(Ljava/lang/String;)V
    ...
    .line 12
    invoke-direct {p0, v0, p1, p2}, Lrjs;-><init>(Ljava/util/concurrent/ExecutorService;D)V
...
.method private constructor <init>(Ljava/util/concurrent/ExecutorService;D)V
    ...
    .line 7
    iput-object p1, p0, Lrjs;->e:Ljava/util/concurrent/ExecutorService;

    .line 8
    iput-wide p2, p0, Lrjs;->f:D
...
.method private static a(Landroid/hardware/Camera$Parameters;D)Landroid/hardware/Camera$Size;
    ...
    invoke-direct {v0, v4}, Lrjt;-><init>(I)V
    ...
    invoke-direct {v3, v1}, Lrju;-><init>(I)V
...
.method private final b(I)Ljava/util/concurrent/Future;
    ...
    .line 97
    iget-object v0, p0, Lrjs;->e:Ljava/util/concurrent/ExecutorService;
...
.method private final declared-synchronized c(I)Landroid/hardware/Camera;
    ...
    invoke-direct {v1, v0}, Lrjx;-><init>(Ljava/lang/Throwable;)V
    ...
    invoke-direct {v0, v2}, Lrjx;-><init>(Ljava/lang/Throwable;)V
    ...
    invoke-direct {v0, v1}, Lrjx;-><init>(Ljava/lang/Throwable;)V
...
.method private final h()V
    ...
    .line 189
    :try_start_0
    iget-object v0, p0, Lrjs;->j:Landroid/hardware/Camera;

    .line 190
    const/4 v1, 0x0

    iput-object v1, p0, Lrjs;->j:Landroid/hardware/Camera;
...
.method public final declared-synchronized a()V
    ...
    .line 25
    :goto_1
    invoke-direct {p0, v0}, Lrjs;->b(I)Ljava/util/concurrent/Future;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized a(F)V
    ...
    :try_start_0
    iget-object v1, p0, Lrjs;->j:Landroid/hardware/Camera;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized a(I)V
    ...
    :try_start_0
    invoke-direct {p0, p1}, Lrjs;->b(I)Ljava/util/concurrent/Future;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized a(Landroid/graphics/SurfaceTexture;)V
    ...
    :try_start_0
    iput-object v0, p0, Lrjs;->k:Landroid/graphics/SurfaceTexture;

    .line 29
    const/4 v0, 0x0

    iput-object v0, p0, Lrjs;->l:Landroid/graphics/SurfaceTexture;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_0
    :try_start_1
    iget-object v0, p0, Lrjs;->k:Landroid/graphics/SurfaceTexture;

    if-nez v0, :cond_1

    .line 32
    iput-object p1, p0, Lrjs;->k:Landroid/graphics/SurfaceTexture;
    ...
    :cond_1
    :try_start_2
    iput-object p1, p0, Lrjs;->l:Landroid/graphics/SurfaceTexture;
...
.method public final declared-synchronized a(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1}, Lrjs;->b(Ljava/lang/String;)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 75
    iget-object v2, p0, Lrjs;->j:Landroid/hardware/Camera;
...
.method public final run()V
    ...
    .line 98
    iget-object v1, p0, Lrjs;->l:Landroid/graphics/SurfaceTexture;

    if-eqz v1, :cond_1

    iget-object v1, p0, Lrjs;->l:Landroid/graphics/SurfaceTexture;

    iget-object v2, p0, Lrjs;->k:Landroid/graphics/SurfaceTexture;
    ...
    iget-object v2, p0, Lrjs;->l:Landroid/graphics/SurfaceTexture;
    ...
    iput-object v1, p0, Lrjs;->k:Landroid/graphics/SurfaceTexture;

    .line 106
    const/4 v1, 0x0

    iput-object v1, p0, Lrjs;->l:Landroid/graphics/SurfaceTexture;
    ...
    .line 113
    :try_start_2
    invoke-direct {p0, v1}, Lrjs;->c(I)Landroid/hardware/Camera;

    move-result-object v2

    iput-object v2, p0, Lrjs;->j:Landroid/hardware/Camera;
    ...
    iput-boolean v3, p0, Lrjs;->b:Z

    .line 117
    iget-object v3, p0, Lrjs;->j:Landroid/hardware/Camera;
    ...
    .line 124
    iget-wide v4, p0, Lrjs;->f:D

    invoke-static {v2, v4, v5}, Lrjs;->a(Landroid/hardware/Camera$Parameters;D)Landroid/hardware/Camera$Size;
    ...
    .line 127
    invoke-static {v2}, Lrjs;->a(Landroid/hardware/Camera$Parameters;)V
    ...
    invoke-direct {v0, v1}, Lrjv;-><init>(Ljava/lang/String;)V
    ...
    iget-object v3, p0, Lrjs;->k:Landroid/graphics/SurfaceTexture;
    ...
    iput-boolean v2, p0, Lrjs;->n:Z

    .line 154
    iput v1, p0, Lrjs;->h:I

    .line 155
    iget-object v1, p0, Lrjs;->d:Lrjw;
    ...
    invoke-interface {v1, v0}, Lrjw;->a(Z)V
    :try_end_7
