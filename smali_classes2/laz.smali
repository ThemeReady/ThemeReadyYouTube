...
.method private final a(Lcom/google/android/gms/cast/MediaInfo;)V
    ...
    invoke-virtual {v0, v2}, Llbd;->cancel(Z)Z
    ...
    iget-boolean v2, p0, Llaz;->c:Z

    invoke-virtual {p0, p1, v0, v2}, Llaz;->a(Lcom/google/android/gms/cast/MediaInfo;Landroid/graphics/Bitmap;Z)V
    :try_end_0
    ...
    invoke-direct {v1, p0, p1}, Llbb;-><init>(Llaz;Lcom/google/android/gms/cast/MediaInfo;)V

    iput-object v1, p0, Llaz;->g:Llbd;

    .line 85
    iget-object v1, p0, Llaz;->g:Llbd;
    ...
    :try_end_1
    .catch Lkzw; {:try_start_1 .. :try_end_1} :catch_0
...
.method protected final a(I)V
    ...
    :try_start_0
    iput-boolean v0, p0, Llaz;->c:Z

    .line 118
    const/4 v0, 0x1

    invoke-virtual {p0, v0}, Llaz;->stopForeground(Z)V
    :try_end_0
    ...
    .line 93
    iget-object v0, p0, Llaz;->f:Lkyt;

    invoke-virtual {v0}, Lkyt;->w()Lcom/google/android/gms/cast/MediaInfo;

    move-result-object v0

    invoke-direct {p0, v0}, Llaz;->a(Lcom/google/android/gms/cast/MediaInfo;)V
    ...
    iput-boolean v2, p0, Llaz;->c:Z

    .line 102
    iget-object v2, p0, Llaz;->f:Lkyt;

    iget-object v3, p0, Llaz;->f:Lkyt;
    ...
    .line 109
    :cond_2
    iget-object v3, v2, Lkyt;->z:Lcom/google/android/gms/cast/MediaStatus;
...
.method protected final a(Lcom/google/android/gms/cast/MediaInfo;Landroid/graphics/Bitmap;Z)V
    ...
    .line 135
    invoke-virtual {p0}, Llaz;->getResources()Landroid/content/res/Resources;
    ...
    iget-object v5, p0, Llaz;->f:Lkyt;

    .line 136
    iget-object v5, v5, Lkyj;->i:Ljava/lang/String;
    ...
    invoke-direct {v2, p0}, Lafd;-><init>(Landroid/content/Context;)V
    ...
    .line 144
    invoke-static {p1}, Llbg;->a(Lcom/google/android/gms/cast/MediaInfo;)Landroid/os/Bundle;
    ...
    iget-object v3, p0, Llaz;->m:Ljava/lang/Class;
    ...
    .line 147
    invoke-static {p0}, Lkj;->a(Landroid/content/Context;)Lkj;

    move-result-object v3

    .line 148
    iget-object v4, p0, Llaz;->m:Ljava/lang/Class;

    .line 149
    new-instance v5, Landroid/content/ComponentName;

    iget-object v6, v3, Lkj;->c:Landroid/content/Context;

    invoke-direct {v5, v6, v4}, Landroid/content/ComponentName;-><init>(Landroid/content/Context;Ljava/lang/Class;)V

    invoke-virtual {v3, v5}, Lkj;->a(Landroid/content/ComponentName;)Lkj;

    .line 150
    invoke-virtual {v3, v0}, Lkj;->a(Landroid/content/Intent;)Lkj;

    .line 152
    iget-object v0, v3, Lkj;->b:Ljava/util/ArrayList;
    ...
    iget-object v2, v3, Lkj;->b:Ljava/util/ArrayList;
    ...
    .line 163
    sget-object v2, Lkj;->a:Lkl;

    iget-object v3, v3, Lkj;->c:Landroid/content/Context;

    const/4 v4, 0x1

    const/high16 v5, 0x8000000

    invoke-interface {v2, v3, v0, v4, v5}, Lkl;->a(Landroid/content/Context;[Landroid/content/Intent;II)Landroid/app/PendingIntent;

    move-result-object v0

    .line 165
    iput-object v0, v1, Lik;->d:Landroid/app/PendingIntent;

    .line 169
    iput-object p2, v1, Lik;->e:Landroid/graphics/Bitmap;
    ...
    iget-object v0, p0, Llaz;->q:[I

    .line 173
    iput-object v0, v2, Lafj;->a:[I

    .line 175
    iget-object v0, p0, Llaz;->f:Lkyt;

    .line 177
    iget-object v3, v0, Lkyt;->E:Lom;
    ...
    .line 179
    :goto_0
    iput-object v0, v2, Lafj;->b:Lpg;

    .line 181
    invoke-virtual {v1, v2}, Lik;->a(Liy;)Lik;
    ...
    .line 192
    iget-object v1, p0, Llaz;->p:Ljava/util/List;
    ...
    .line 212
    invoke-virtual {p0}, Llaz;->getPackageName()Ljava/lang/String;
    ...
    .line 215
    invoke-virtual {p0, v2}, Llaz;->getString(I)Ljava/lang/String;

    move-result-object v2

    invoke-direct {v5, v1, v2, v4}, Lih;-><init>(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)V

    invoke-virtual {v5}, Lih;->a()Lif;
    ...
    .line 199
    invoke-virtual {p0, v5}, Llaz;->getString(I)Ljava/lang/String;

    move-result-object v5

    invoke-direct {v2, v4, v5, v1}, Lih;-><init>(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)V
    ...
    invoke-direct {v4, v1, v5, v2}, Lih;-><init>(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)V

    invoke-virtual {v4}, Lih;->a()Lif;
    ...
    iput-object v0, p0, Llaz;->d:Landroid/app/Notification;
...
.method public onCreate()V
    ...
    .line 6
    invoke-static {p0, v0}, Llbg;->a(Landroid/content/Context;F)I
    ...
    iput-object v0, p0, Llaz;->f:Lkyt;

    .line 9
    iget-object v0, p0, Llaz;->f:Lkyt;

    .line 10
    iget-object v0, v0, Lkyj;->b:Lkyp;

    .line 12
    iput-object v4, p0, Llaz;->m:Ljava/lang/Class;

    .line 13
    iget-object v0, p0, Llaz;->m:Ljava/lang/Class;
    ...
    iput-object v0, p0, Llaz;->m:Ljava/lang/Class;
    ...
    invoke-virtual {v0, v3, v4}, Lkyj;->a(ILjava/lang/String;)V
    ...
    .line 20
    iget-object v0, v0, Lkyt;->y:Lkys;

    .line 22
    if-eqz v0, :cond_2

    .line 23
    invoke-virtual {v0}, Lkys;->b()I

    move-result v3

    .line 24
    invoke-virtual {v0}, Lkys;->a()I
    ...
    :goto_0
    iput-boolean v0, p0, Llaz;->i:Z

    .line 26
    if-lez v3, :cond_4

    :goto_1
    iput-boolean v1, p0, Llaz;->j:Z
    ...
    iput-object v0, p0, Llaz;->o:Lkzv;

    .line 28
    iget-object v0, p0, Llaz;->f:Lkyt;

    iget-object v1, p0, Llaz;->o:Lkzv;
    ...
    .line 31
    iget-object v0, v0, Lkyp;->a:Ljava/util/List;

    .line 32
    iput-object v0, p0, Llaz;->p:Ljava/util/List;
    ...
    .line 35
    iget-object v1, v0, Lkyp;->b:Ljava/util/List;
...
.method public onDestroy()V
    ...
    invoke-virtual {p0, v0}, Llaz;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    .line 55
    invoke-virtual {p0, v0}, Llaz;->a(I)V

    .line 56
    iget-object v0, p0, Llaz;->d:Landroid/app/Notification;
    ...
    invoke-virtual {p0, v3, v0}, Llaz;->startForeground(ILandroid/app/Notification;)V
    ...
    .line 63
    :cond_2
    invoke-virtual {p0, v3}, Llaz;->stopForeground(Z)V
