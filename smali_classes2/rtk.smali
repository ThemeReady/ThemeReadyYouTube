...
.method final declared-synchronized a([BII)V
    ...
    .line 12
    :goto_0
    invoke-virtual {p0}, Lrtk;->available()I
    ...
    :cond_0
    :try_start_3
    iget v2, p0, Lrtk;->out:I

    iget v3, p0, Lrtk;->in:I
    ...
    .line 32
    iget-object v3, p0, Lrtk;->buffer:[B

    iget v4, p0, Lrtk;->in:I
    ...
    invoke-virtual {p0, v0}, Lrtk;->receive(I)V
    ...
    .line 21
    iget v2, p0, Lrtk;->in:I

    iget v3, p0, Lrtk;->out:I

    if-le v2, v3, :cond_0

    .line 22
    iget-object v2, p0, Lrtk;->buffer:[B
