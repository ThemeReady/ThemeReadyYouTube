...
.field private synthetic b:Lovb;

.field private synthetic c:Lulh;


# direct methods
.method public constructor <init>(Lulh;ZLovb;)V
    .locals 0

    .prologue
    .line 1
    iput-object p1, p0, Lulj;->c:Lulh;

    iput-boolean p2, p0, Lulj;->a:Z

    iput-object p3, p0, Lulj;->b:Lovb;
...
.method public final run()V
    ...
    .line 2
    iget-object v3, p0, Lulj;->c:Lulh;

    iget-boolean v4, p0, Lulj;->a:Z

    iget-object v5, p0, Lulj;->b:Lovb;

    .line 3
    iget-object v0, v3, Lulh;->c:Lukh;

    iget-object v6, v3, Lulh;->a:Landroid/content/SharedPreferences;

    iget-object v7, v3, Lulh;->d:Landroid/content/Context;

    .line 5
    invoke-interface {v0}, Lukh;->a()Z
    ...
    .line 17
    invoke-static {v7}, Lulo;->a(Landroid/content/Context;)Ljava/lang/Boolean;
    ...
    .line 30
    invoke-static {v6}, Lulo;->b(Landroid/content/SharedPreferences;)Ljava/lang/Long;
    ...
    .line 40
    invoke-static {v6}, Lulo;->a(Landroid/content/SharedPreferences;)V

    .line 42
    :cond_1
    if-nez v0, :cond_2

    iget-object v0, v3, Lulh;->a:Landroid/content/SharedPreferences;
