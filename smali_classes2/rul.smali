...
# direct methods
.method constructor <init>(Lruj;Ljava/lang/String;)V
    .locals 0

    .prologue
    .line 1
    iput-object p1, p0, Lrul;->a:Lruj;
...
.method public final run()V
    ...
    :cond_0
    :try_start_0
    iget-boolean v3, v1, Lruj;->n:Z

    if-nez v3, :cond_2

    iget-object v3, v1, Lruj;->d:Lrtq;
    ...
    .line 7
    invoke-virtual {v3, v0, v4, v5}, Lrtq;->read([BII)I
    ...
    .line 11
    :goto_0
    iget-object v3, v1, Lruj;->c:Ljava/nio/channels/SocketChannel;
    ...
    .line 31
    invoke-virtual {v1, v0}, Lruj;->a(Ljava/lang/Throwable;)V
    :try_end_4
    ...
    .line 38
    :try_start_6
    iget-object v1, v1, Lruj;->d:Lrtq;

    invoke-virtual {v1}, Lrtq;->close()V
    :try_end_6
