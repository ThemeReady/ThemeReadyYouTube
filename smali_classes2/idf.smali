...
# direct methods
.method constructor <init>(Lcom/google/android/libraries/youtube/common/ui/TouchImageView;Landroid/widget/ProgressBar;Lidj;)V
    .locals 0
    ...
    .line 2
    iput-object p1, p0, Lidf;->a:Lcom/google/android/libraries/youtube/common/ui/TouchImageView;

    .line 3
    iput-object p2, p0, Lidf;->b:Landroid/widget/ProgressBar;

    .line 4
    iput-object p3, p0, Lidf;->c:Lidj;
...
.method final a()Landroid/graphics/drawable/Drawable;
    ...
    .prologue
    .line 35
    iget-object v0, p0, Lidf;->i:Landroid/graphics/drawable/Drawable;

    if-nez v0, :cond_0

    .line 36
    iget-object v0, p0, Lidf;->a:Lcom/google/android/libraries/youtube/common/ui/TouchImageView;
    ...
    iput-object v0, p0, Lidf;->i:Landroid/graphics/drawable/Drawable;
...
.method final a(I)V
    ...
    invoke-direct {v1, p0}, Lidi;-><init>(Lidf;)V
    ...
    .line 8
    iget-object v0, p0, Lidf;->b:Landroid/widget/ProgressBar;
    ...
    .line 11
    :pswitch_0
    iget-object v0, p0, Lidf;->f:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Lidf;->f:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v0, v1}, Lidf;->a(Landroid/graphics/drawable/Drawable;I)V

    goto :goto_0

    .line 19
    :pswitch_1
    iget-object v0, p0, Lidf;->h:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Lidf;->h:Landroid/graphics/drawable/Drawable;
    ...
    .line 26
    :pswitch_2
    iget-object v0, p0, Lidf;->g:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Lidf;->g:Landroid/graphics/drawable/Drawable;
...
.method final a(Landroid/graphics/drawable/Drawable;I)V
    ...
    iget-object v1, p0, Lidf;->a:Lcom/google/android/libraries/youtube/common/ui/TouchImageView;
