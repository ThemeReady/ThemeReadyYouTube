...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcxa;->a:[I

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Lzle;)V
    .locals 1
    ...
    iput-object v0, p0, Lcxa;->b:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcxa;->d:Lzle;

    .line 4
    invoke-static {p1}, Laeft;->a(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Lcxa;->c:Ljava/lang/String;
...
.method public final a(Landroid/app/Activity;Landroid/net/Uri;)Z
    ...
    .line 6
    iget-object v0, p0, Lcxa;->c:Ljava/lang/String;
    ...
    iget-object v4, p0, Lcxa;->b:Landroid/content/Context;

    .line 8
    sget-object v5, Logf;->a:Logh;
    ...
    .line 17
    invoke-virtual {v5, v4}, Logh;->a(Landroid/content/Context;)Ljava/util/Set;
    ...
    .line 30
    iget-object v0, p0, Lcxa;->d:Lzle;

    iget-boolean v0, v0, Lzle;->b:Z
    ...
    invoke-static {p1, v0, v1}, Lozs;->a(Landroid/content/Context;II)I
    ...
    .line 45
    iget-object v1, p0, Lcxa;->b:Landroid/content/Context;
    ...
    invoke-direct {v4, v1}, Leu;-><init>(Landroid/app/ActivityOptions;)V

    .line 53
    invoke-direct {v0, v4}, Leq;-><init>(Leu;)V

    .line 73
    :goto_3
    invoke-virtual {v0}, Len;->a()Landroid/os/Bundle;
    ...
    iget-object v5, p0, Lcxa;->b:Landroid/content/Context;
    ...
    iget-object v2, p0, Lcxa;->c:Ljava/lang/String;
    ...
    invoke-static {v1, v2, p2}, Logf;->a(Landroid/content/Context;Landroid/content/Intent;Landroid/net/Uri;)V
    ...
    iget-object v3, p0, Lcxa;->b:Landroid/content/Context;
    ...
    invoke-static {p1, v1, v0}, Lkb;->a(Landroid/content/Context;Landroid/content/Intent;Landroid/os/Bundle;)V
    ...
    invoke-direct {v4, v1}, Let;-><init>(Landroid/app/ActivityOptions;)V

    .line 59
    invoke-direct {v0, v4}, Lep;-><init>(Let;)V
    ...
    invoke-direct {v4, v1}, Les;-><init>(Landroid/app/ActivityOptions;)V

    .line 65
    invoke-direct {v0, v4}, Leo;-><init>(Les;)V
    ...
    invoke-direct {v4, v1}, Lev;-><init>(Landroid/app/ActivityOptions;)V

    .line 71
    invoke-direct {v0, v4}, Ler;-><init>(Lev;)V
