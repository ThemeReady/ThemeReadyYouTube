...
# static fields
.field private static volatile i:[Lkpq;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lkpq;->d:Ljava/lang/String;

    iput-object v0, p0, Lkpq;->e:Ljava/lang/String;

    iput-object v0, p0, Lkpq;->f:Ljava/lang/Boolean;

    iput-object v0, p0, Lkpq;->g:Ljava/lang/Boolean;

    iput-object v0, p0, Lkpq;->h:Ljava/lang/Integer;
...
.method protected final a()I
    ...
    iget-object v2, p0, Lkpq;->c:Ljava/lang/String;
    ...
    :cond_2
    iget-object v1, p0, Lkpq;->d:Ljava/lang/String;

    if-eqz v1, :cond_3

    const/4 v1, 0x4

    iget-object v2, p0, Lkpq;->d:Ljava/lang/String;
    ...
    iget-object v2, p0, Lkpq;->e:Ljava/lang/String;
    ...
    :cond_4
    iget-object v1, p0, Lkpq;->f:Ljava/lang/Boolean;

    if-eqz v1, :cond_5

    const/4 v1, 0x6

    iget-object v2, p0, Lkpq;->f:Ljava/lang/Boolean;
    ...
    :cond_5
    iget-object v1, p0, Lkpq;->g:Ljava/lang/Boolean;

    if-eqz v1, :cond_6

    const/4 v1, 0x7

    iget-object v2, p0, Lkpq;->g:Ljava/lang/Boolean;
    ...
    :cond_6
    iget-object v1, p0, Lkpq;->h:Ljava/lang/Integer;

    if-eqz v1, :cond_7

    const/16 v1, 0x8

    iget-object v2, p0, Lkpq;->h:Ljava/lang/Integer;
    ...
    :cond_7
    iget-object v1, p0, Lkpq;->j:Ljava/lang/Integer;

    if-eqz v1, :cond_8

    const/16 v1, 0x9

    iget-object v2, p0, Lkpq;->j:Ljava/lang/Integer;
...
.method public final synthetic a(Lkko;)Lkkx;
    ...
    iput-object v0, p0, Lkpq;->j:Ljava/lang/Integer;
...
.method public final a(Lkkp;)V
    ...
    :cond_2
    iget-object v0, p0, Lkpq;->d:Ljava/lang/String;
    ...
    :cond_4
    iget-object v0, p0, Lkpq;->f:Ljava/lang/Boolean;
    ...
    :cond_5
    iget-object v0, p0, Lkpq;->g:Ljava/lang/Boolean;
    ...
    :cond_6
    iget-object v0, p0, Lkpq;->h:Ljava/lang/Integer;
    ...
    :cond_7
    iget-object v0, p0, Lkpq;->j:Ljava/lang/Integer;
