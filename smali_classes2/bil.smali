...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lbil;->e:Ljava/util/Set;
    ...
    sput-object v0, Lbil;->f:Ljava/util/Set;

    .line 196
    invoke-static {v4}, Lbnk;->a(I)Ljava/util/Queue;

    move-result-object v0

    sput-object v0, Lbil;->g:Ljava/util/Queue;

    return-void
.end method

.method public constructor <init>(Ljava/util/List;Landroid/util/DisplayMetrics;Lbct;Lbco;)V
    .locals 1
    ...
    .line 2
    iput-object p1, p0, Lbil;->k:Ljava/util/List;
    ...
    iput-object v0, p0, Lbil;->i:Landroid/util/DisplayMetrics;
    ...
    iput-object v0, p0, Lbil;->h:Lbct;

    .line 10
    const-string v0, "Argument must not be null"

    invoke-static {p4, v0}, Lbnj;->a(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
    ...
    iput-object v0, p0, Lbil;->j:Lbco;

    .line 12
    return-void
.end method

.method private final a(Ljava/io/InputStream;Layz;)Landroid/graphics/Bitmap$Config;
    .locals 3
    ...
    .line 112
    :try_start_0
    iget-object v1, p0, Lbil;->k:Ljava/util/List;

    iget-object v2, p0, Lbil;->j:Lbco;
...
.method private static a(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;Lbin;Lbct;)Landroid/graphics/Bitmap;
    .locals 11
    ...
    .line 124
    sget-object v4, Lbiu;->a:Ljava/util/concurrent/locks/Lock;
    ...
    invoke-interface {p3, v0}, Lbct;->a(Landroid/graphics/Bitmap;)V
    ...
    .line 145
    invoke-static {p0, p1, p2, p3}, Lbil;->a(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;Lbin;Lbct;)Landroid/graphics/Bitmap;
    :try_end_2
...
.method private final a(Ljava/io/InputStream;)Z
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Lbil;->k:Ljava/util/List;

    iget-object v1, p0, Lbil;->j:Lbco;

    invoke-static {v0, p1, v1}, Lazf;->a(Ljava/util/List;Ljava/io/InputStream;Lbco;)Laze;

    move-result-object v0

    .line 106
    sget-object v1, Lbil;->f:Ljava/util/Set;
...
.method private static b(Landroid/graphics/BitmapFactory$Options;)V
    ...
    .prologue
    .line 166
    invoke-static {p0}, Lbil;->c(Landroid/graphics/BitmapFactory$Options;)V

    .line 167
    sget-object v1, Lbil;->g:Ljava/util/Queue;

    monitor-enter v1

    .line 168
    :try_start_0
    sget-object v0, Lbil;->g:Ljava/util/Queue;
...
.method private static declared-synchronized c()Landroid/graphics/BitmapFactory$Options;
    ...
    :try_start_0
    sget-object v2, Lbil;->g:Ljava/util/Queue;
    ...
    .line 164
    invoke-static {v0}, Lbil;->c(Landroid/graphics/BitmapFactory$Options;)V
    :try_end_2
...
# virtual methods
.method public final a(Ljava/io/InputStream;IILazk;Lbin;)Lbch;
    .locals 15
    ...
    invoke-static {v2, v3}, Lbnj;->a(ZLjava/lang/String;)V
    ...
    invoke-interface {v2, v3, v4}, Lbco;->a(ILjava/lang/Class;)Ljava/lang/Object;
    ...
    .line 17
    invoke-static {}, Lbil;->c()Landroid/graphics/BitmapFactory$Options;
    ...
    .line 19
    sget-object v3, Lbil;->a:Lazh;

    move-object/from16 v0, p4

    invoke-virtual {v0, v3}, Lazk;->a(Lazh;)Ljava/lang/Object;
    ...
    .line 20
    sget-object v4, Lbil;->b:Lazh;

    move-object/from16 v0, p4

    invoke-virtual {v0, v4}, Lazk;->a(Lazh;)Ljava/lang/Object;
    ...
    .line 21
    sget-object v5, Lbil;->d:Lazh;

    move-object/from16 v0, p4

    invoke-virtual {v0, v5}, Lazk;->a(Lazh;)Ljava/lang/Object;
    ...
    invoke-static {v0, v9, v1, v5}, Lbil;->a(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;Lbin;Lbct;)Landroid/graphics/Bitmap;
    ...
    .line 32
    iget-object v5, p0, Lbil;->k:Ljava/util/List;

    iget-object v6, p0, Lbil;->j:Lbco;

    move-object/from16 v0, p1

    invoke-static {v5, v0, v6}, Lazf;->b(Ljava/util/List;Ljava/io/InputStream;Lbco;)I

    move-result v11

    .line 33
    invoke-static {v11}, Lbiu;->a(I)I
    ...
    invoke-direct {p0, v0, v3}, Lbil;->a(Ljava/io/InputStream;Layz;)Landroid/graphics/Bitmap$Config;
    ...
    .line 74
    :cond_2
    invoke-direct/range {p0 .. p1}, Lbil;->a(Ljava/io/InputStream;)Z
    ...
    invoke-interface {v5, v4, v3, v6}, Lbct;->b(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    .line 88
    :cond_3
    iget-object v3, p0, Lbil;->h:Lbct;

    move-object/from16 v0, p1

    move-object/from16 v1, p5

    invoke-static {v0, v9, v1, v3}, Lbil;->a(Ljava/io/InputStream;Landroid/graphics/BitmapFactory$Options;Lbin;Lbct;)Landroid/graphics/Bitmap;
    ...
    invoke-interface {v0, v3, v4}, Lbin;->a(Lbct;Landroid/graphics/Bitmap;)V
    ...
    .line 92
    iget-object v3, p0, Lbil;->i:Landroid/util/DisplayMetrics;
    ...
    invoke-static {v3, v4, v11}, Lbiu;->a(Lbct;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    invoke-interface {v5, v4}, Lbct;->a(Landroid/graphics/Bitmap;)V

    .line 97
    :cond_4
    iget-object v4, p0, Lbil;->h:Lbct;

    invoke-static {v3, v4}, Lbhu;->a(Landroid/graphics/Bitmap;Lbct;)Lbhu;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 98
    invoke-static {v9}, Lbil;->b(Landroid/graphics/BitmapFactory$Options;)V

    .line 99
    iget-object v4, p0, Lbil;->j:Lbco;

    const-class v5, [B

    invoke-interface {v4, v2, v5}, Lbco;->a(Ljava/lang/Object;Ljava/lang/Class;)V
    ...
    :cond_8
    :try_start_1
    invoke-virtual {v4, v7, v8, v5, v3}, Lbie;->a(IIII)F
    ...
    :cond_9
    :try_start_2
    invoke-virtual {v4, v8, v7, v5, v3}, Lbie;->a(IIII)F
    ...
    sget-object v13, Lbil;->e:Ljava/util/Set;
    ...
    .line 69
    :cond_d
    invoke-static {v9}, Lbil;->a(Landroid/graphics/BitmapFactory$Options;)Z
